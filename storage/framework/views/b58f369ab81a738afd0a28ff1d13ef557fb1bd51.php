                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="customer_add" name="customer_add" method="POST" action="<?php echo e(action('admin\ManageCustomerController@editData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="jack" value="<?php echo e($customer->first_name); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="rich" value="<?php echo e($customer->last_name); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="emailID" name="emailID" placeholder="jack@mail.com" value="<?php echo e($customer->emailID); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="phone" value="<?php echo e($customer->phone); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="address" name="address" placeholder="address" ><?php echo e($customer->address); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="state" name="state" placeholder="State" value="<?php echo e($customer->state); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Country..." class="chosen-select"  style="width: 100%;" tabindex="2" name="country" id="country">
                                            ...
                                            { ?>
                                                <option value="<?php echo e($key); ?>"  <?php  if($customer->country == $key){ echo 'selected'; } ?> >
                                                    <?php echo e($value); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        ?>
                                        <input type="checkbox" class="js-switch_2" name="status" id="status" <?php echo e($checked); ?> value="<?php echo e($customer->status); ?>" />
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
