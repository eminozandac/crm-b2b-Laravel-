                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="<?php if($currentPage == 'admin/grouplist'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/grouplist')}}">Group List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
						<li class="<?php if (Request::is('admin/productList')){echo 'active';} ?>"><a href="{{action('admin\ProductController@productList')}}">Product list</a></li>
						
						<li class="<?php if (Request::is('admin/attributeList')){echo 'active';} ?>"><a href="{{action('admin\AttributeController@index')}}">Attribute list</a></li>
						
                        <li class="<?php if (Request::is('admin/brandList')){echo 'active';} ?>"><a href="{{action('admin\ProductController@brandList')}}">Brand list</a></li>

						<li class="<?php if (Request::is('admin/productCategoriesList')){echo 'active';} ?>"><a href="{{action('admin\ProductController@productCategoriesList')}}">Category list</a></li>
						
						<li class="<?php if (Request::is('admin/addvariation')){echo 'active';} ?>"><a href="{{action('admin\ProductController@addVariation')}}">Add Variation</a></li>
                    </ul>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
						<li class="<?php if (Request::is('admin/accessorylist')){echo 'active';} ?>"><a href="{{action('admin\AccessoryController@accessoryList')}}">Accessory list</a></li>
						
						<li class="<?php if (Request::is('admin/accessorycategorieslist')){echo 'active';} ?>"><a href="{{action('admin\AccessoryController@accessoryCategoriesList')}}">Category list</a></li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                         <li class="<?php if (Request::is('admin/orderList')){echo 'active';} ?>"><a href="{{action('admin\OrderController@orderList')}}">Product Order</a></li>
						  <?php
							$activeClass = '';
							...
							?>
						 <li class="<?php  echo $activeClass;  ?>">
                            <a href="{{URL('/admin/financeorder')}}">Finance Order</a>
                        </li> 
						<?php
							$activeClass = '';
							...
							?>
						 <li class="<?php  echo $activeClass;  ?>">
                            <a href="{{URL('/admin/specialorderslist')}}">Special Order</a>
                        </li>
						<?php
							$activeClass = '';
							...
							?>
						 <li class="<?php  echo $activeClass;  ?>">
                            <a href="{{URL('/admin/accessoryorderslist')}}">Accessory Order</a>
                        </li>
                    </ul>
                </li>
                ...
                ?>
                <li class="<?php echo $activeClass; ?>">
                    <a href="{{URL('/admin/invoicelist')}}"><i class="fa fa-file"></i> <span class="nav-label">My Invoice</span></a>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="<?php if($currentPage == 'admin/dealerlist'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/dealerlist')}}">Dealer List</a>
                        </li>
                    </ul>
                </li>
				...
				<li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="<?php if($currentPage == 'admin/stockManage'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/stockManage')}}">view Stock</a>
                        </li>
						<?php
							$activeClass = '';
						...
						<li class="<?php if($currentPage == 'admin/inproductionstockmanage'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/inproductionstockmanage')}}">In Production Stock</a>
                        </li>
						<?php
							$activeClass = '';
						...
						<li class="<?php if($currentPage == 'admin/inseaarrivalukstockmanage'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/inseaarrivalukstockmanage')}}">On Sea Arrival Stock</a>
                        </li>
						<?php
							$activeClass = '';
						...
						<li class="<?php if($currentPage == 'admin/factorystockmanage'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/factorystockmanage')}}">Factory Stock</a>
                        </li>
						<?php
							$activeClass = '';
							if(($currentPage == 'admin/batchwisestockmanage')){
						...
						<li class="<?php if($currentPage == 'admin/batchwisestockmanage'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/batchwisestockmanage')}}">View Batch's</a>
                        </li>
						<?php
							$activeClass = '';
						...
						<li class="<?php if($currentPage == 'admin/completedorders'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/completedorders')}}">Completed Order</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="<?php if($currentPage == 'admin/stafflist'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/stafflist')}}">Staff List</a>
                        </li>
                    </ul>
                </li>
                @endif
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="<?php if($currentPage == 'admin/employeelist'){ echo 'active'; } ?>">
                            <a href="{{URL('/admin/employeelist')}}">Employee List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="{{ $activeClass }}">
                            <a href="{{ URL::to('admin/warranty') }}">Warranty</a>
                        </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="<?php if($currentPage == 'admin/mediacategorylist'){ echo 'active'; } ?>">
                            <a href="{{ URL('/admin/mediacategorylist' )}}">Media Main Category</a>
                        </li>
                        <li class="<?php if($currentPage == 'admin/mediacategorysublist'){ echo 'active'; } ?>">
                            <a href="{{ URL('/admin/mediacategorysublist' )}}">Media Sub Category</a>
                        </li>
                        <li class="<?php if($currentPage == 'admin/mediacategoryfile'){ echo 'active'; } ?>">
                            <a href="{{ URL('/admin/mediacategoryfile' )}}">Media File</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <a href="{{URL('/logdata/loglistdata')}}"><i class="fa fa-info-circle"></i> <span class="nav-label">Log</span></a>
                ...
                <li class="<?php echo $activeClass; ?>">
                    <a href="{{URL('databasebackup')}}"><i class="fa fa-hdd-o"></i> <span class="nav-label">Backup</span></a>
                </li>
