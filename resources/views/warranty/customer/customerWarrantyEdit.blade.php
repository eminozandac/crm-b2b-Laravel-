...
@section('contentPages')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="{{URL::to('/customer/dashboard')}}">Home</a>
                </li>
                <li class="active">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="{{ action('customer\WarrantyCustomerController@warrantySaveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="emailID" name="emailID" placeholder="john@mail.com" value="{{ $emailID }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
...
@section('pagescript')
    ...
    <script>
        $(function()
        {
            ...
            {
                url: "{{ URL::to('/customer/warrantyfile/') }}",
                method : "post",
                paramName: "note_file",
                ...
                init: function()
                {
                    ...
                    this.on("removedfile", function(file)
                    {
                        ...
                        if (rmvFile)
                        {
                            ...
                            var file_name_string = hidden_file_note.join(",");
                            $('#hidden_file_images').val(file_name_string);
                            $.post("{{ URL::to('/customer/warrantyremove/') }}", {
             ...
             var hidden_token_file = $("#hidden_token_file").val();
                $.post("{{ URL::to('/customer/warrantygetimages/') }}", { data_warranty_uniqueID : warranty_uniqueID, _token: hidden_token_file },
                function(data)
                {
