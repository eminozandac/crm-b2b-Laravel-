                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/admin/dealeradd')); ?>"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                $(function (){
                    ...
                    var customer_table = $('#dealer_table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            url: "<?php echo e(URL::to('admin/ajax/log/dealerdata')); ?>",
                            data:function(d){  }
                        },
                        "columns": [
						...
						swal({
							...
							function(isConfirm){
								if (isConfirm) {
									...
									({
										type: "POST",
										url: "<?php echo e(URL::to('admin/ajax/log/dealerdelete')); ?>",
