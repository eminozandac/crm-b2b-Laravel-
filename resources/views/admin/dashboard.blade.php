        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <h5><a href="{{ URL::to('/admin/productList') }}">Products</a></h5>
                    </div>
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <h5><a href="{{ URL::to('/admin/orderList') }}">Orders</a></h5>
                    </div>
                    <div class="ibox-content">
			...
			<div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <span class="label label-info pull-right"></span>
                        <h5><a href="{{ URL::to('/admin/orderList') }}">Special Orders</a></h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins"><?php
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <h5><a href="{{ URL::to('/admin/productCategoriesList') }}">Categories</a></h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins">
                            <?php
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <span class="label label-success pull-right"></span>
                        <h5><a href="{{ URL::to('/admin/dealerlist') }}">Dealers</a></h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins">
                            <?php
            ...
            <div class="col-lg-3">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <span class="label label-success pull-right"></span>
                        <h5><a href="{{ URL::to('/admin/warranty') }}">Warranty</a></h5>
                    </div>
                    <div class="ibox-content">
                        <h1 class="no-margins">
                            <?php
                                    ...
                                    <div class="feed-element">
                                        <div>
                                            ...
                                            <div style="margin-bottom: 10px;"> Description
                                                : {{ \Illuminate\Support\Str::limit($value_note->description, $limit = 100, $end = '...')  }}</div>
                                            <small class="text-muted">
                                                Time : {{ date('H:i A',strtotime($value_note->created_at)) }}
                                                - {{ date('d-m-Y',strtotime($value_note->created_at)) }}
                                            </small>
                                    ...
                                    <div class="feed-element">
                                        <div>
                                            ...
                                            <strong class="pull-right" style="margin-right: 15px;">
                                                <a href="{{ URL::to('admin/warranty') }}">{{ $model_name }}</a>
                                            </strong>
