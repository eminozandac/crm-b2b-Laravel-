        ...
        <div class="page">
            <div class="container">
                ...
                <table cellspacing="2" cellpadding="0" border="0" style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="7" rowspan="8" width="50%" style="padding-bottom: 2mm;border: 1px solid #000;">
                            <table>
                                <tr>
                        ...
                        <td colspan="7" rowspan="4" style="border: 1px solid #000;">
                            <table>
                                <tr>
                    ...
                    <tr>
                        <td colspan="7" rowspan="4" style="padding-bottom: 2mm; border: 1px solid #000;">
                            <table>
                                <tr>
                    ...
                    <tr>
                        <td colspan="14" rowspan="3" width="100%" style="border: 1px solid #000;">
                            <table>
                                <tr>
                                    <td><h3>Fault :</h3></td>
                                    <td>{{ $fault }}</td>
