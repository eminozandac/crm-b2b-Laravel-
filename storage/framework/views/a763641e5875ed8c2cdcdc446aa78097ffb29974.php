                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="<?php echo e(action('staff\StaffController@profile')); ?>">Profile</a></li>
                            <li><a href="<?php echo e(action('staff\StaffController@logout')); ?>">Logout</a></li>
                        </ul>
                    </div>
                ...
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('staff\StaffController@index')); ?>">
                ...
                ?>
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('staff\StaffLeadsController@index')); ?>">
                ...
                ?>
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('staff\StaffTaskController@index')); ?>">
                ...
                ?>
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('staff\StaffCalenderController@index')); ?>">
                ...
                <li class="<?php echo $activeClass; ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        ?>
                        <li class="<?php echo e($activeClass); ?>">
                            <a href="<?php echo e(URL::to('staff/warranty')); ?>">Warranty</a>
                        </li>
