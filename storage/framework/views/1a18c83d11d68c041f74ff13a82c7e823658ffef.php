...
<div class="page">
    <div class="container">
                ...
                <td colspan="14" rowspan="3" width="100%" style="height:85px;border: 1px solid #000;">
                    <table>
                        <tr>
                            ...
                            <td><?php echo e($additional_note); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td colspan="7" rowspan="3" width="50%" style="border: 1px solid #000;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <span><?php echo e($customer_name); ?></span>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <?php if(isset($data_print) && ($data_print == 'pass')): ?>
