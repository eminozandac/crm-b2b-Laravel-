...
class Customer extends Model {
    ...
    protected $fillable = ['customer_id', 'first_name', 'last_name', 'emailID', 'password', 'phone', 'address', 'city', 'state', 'country', 'role', 'status', 'customerAvatar', 'created_at', 'updated_at', 'deleted_at'];
