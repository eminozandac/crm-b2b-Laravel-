...
class MediaCategoryFile extends Model {

    public $timestamps=true;
    protected $dates = ['deleted_at'];

    protected $table = 'media_category_file';

    protected $hidden = array('password', 'remember_token');

    protected $primaryKey = ['media_file_uniqueID']; // or null

    public $incrementing = false;

    protected $fillable = ['media_file_uniqueID', 'media_uniqueID', 'file_type', 'old_file_name', 'file_name', 'created_at', 'updated_at', 'deleted_at'];

    protected $rules=[
        'media_file_uniqueID'=>'required'
    ];
