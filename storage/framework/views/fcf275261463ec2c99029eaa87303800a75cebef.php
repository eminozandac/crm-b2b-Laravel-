        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/admin/dealerlist')); ?>">All Dealer</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="dealer_add" name="dealer_add" method="POST" action="<?php echo e(action('admin\ManageDealerController@editData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">

                                <input name="_token" type="hidden" id="hidden_token" value="<?php echo e(csrf_token()); ?>"/>
                                <input name="id" type="hidden" id="id" value="<?php echo e($dealer->id); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Group..." class="form-control "  style="width: 100%;" tabindex="3" name="groupID" id="groupID">
                                            ...
                                            { ?>
                                            <option value="<?php echo e($key); ?>"   <?php  if($dealer->groupID == $key){ echo 'selected'; } ?> >
                                                <?php echo e($value); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="company_name" name="company_name" placeholder="jack" value="<?php echo e($dealer->company_name); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Category..." class="chosen-select" multiple style="width: 100%" required tabindex="4" name="categoryID[]" id="categoryID">
                                            ...
                                            { ?>
                                                <option value="<?php echo e($key); ?>" <?php  if(in_array($key, explode(',', $dealer->categoryID)) ) { echo 'selected'; }?> >
                                                    <?php echo e($value); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="jack" value="<?php echo e($dealer->first_name); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="rich" value="<?php echo e($dealer->last_name); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="invoicePrefix" name="invoicePrefix" placeholder="jony" value="<?php echo e($dealer->invoicePrefix); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="emailID" name="emailID" placeholder="jack@mail.com" value="<?php echo e($dealer->emailID); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="phone" id="phone" placeholder="Phone"  value="<?php echo e($dealer->phone); ?>">
									</div>
								</div>
								<div class="hr-line-dashed"></div>
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="address" style="height:100px;" name="address" placeholder="Billing Address" ><?php echo e($dealer->address); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="shipping_address" name="shipping_address" style="height:100px;" placeholder="Shipping Address" ><?php echo e($dealer->shipping_address); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id=" " name="contactperson1" style="height:100px;" placeholder="Contact person 1" ><?php echo e($dealer->contactperson1); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="contactperson2" name="contactperson2" style="height:100px;" placeholder="Contact person 2" ><?php echo e($dealer->contactperson2); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div> 
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="contactperson3" name="contactperson3" style="height:100px;" placeholder="Contact person 3" ><?php echo e($dealer->contactperson3); ?></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div> 
