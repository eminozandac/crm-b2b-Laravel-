                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="{{ action('customer\WarrantyCustomerController@warrantySaveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="name" name="name" placeholder="john" value="{{ $customer_data->first_name }} {{ $customer_data->last_name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="emailID" name="emailID" placeholder="john@mail.com" value="{{ $customer_data->emailID }}">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
