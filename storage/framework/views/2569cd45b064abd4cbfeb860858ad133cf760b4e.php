        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/staff/leadsreport')); ?>">All Leads Report</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="leadreport_edit" name="leadreport_edit" method="POST" action="<?php echo e(action('staff\StaffLeadsController@editData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a User..."  class="chosen-select"  style="width: 100%;" tabindex="2" name="assign_id" id="assign_id">
                                            <?php if(!empty($staff_assign)): ?>
                                                <?php foreach($staff_assign as $key => $value): ?>
                                                    <option value="<?php echo e($key); ?>" <?php  if($leads->assign_id == $key){ echo 'selected'; } ?> ><?php echo e($value); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-control" name="lead_status"  id="lead_status" >
											...
											<?php if(!empty($lead_status_report)): ?>
                                                <?php foreach($lead_status_report as $key_report => $value_report): ?>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo e($key_report); ?>" <?php echo e($selected); ?>>
                                                        <?php echo e($value_report); ?>
