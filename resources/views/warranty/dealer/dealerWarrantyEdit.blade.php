...
@section('contentPages')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="{{URL::to('/dealer/dashboard')}}">Home</a>
                </li>
                <li class="active">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="{{ action('dealer\WarrantyDealerController@warrantySaveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="name" name="name" placeholder="john" value="{{ $warrantyData->name }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea required class="form-control" id="address" name="address">{{ $warrantyData->address }}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="postcode" name="postcode" placeholder="" value="{{ $warrantyData->postcode }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="emailID" name="emailID" placeholder="john@mail.com" value="{{ $warrantyData->emailID }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="phone" name="phone" placeholder="1234" value="{{ $warrantyData->phone }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="product_model" name="product_model" placeholder="Hot tub" value="{{ $warrantyData->product_model }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea required class="form-control" id="product_fault" name="product_fault">{{ $warrantyData->product_fault }}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="part_require" name="part_require" placeholder="" value="{{ $warrantyData->part_require }}" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
...
@section('pagescript')
            ...
            .formValidation({
                ...
                fields: {
                    ...
                    postcode: {
                        ...
                        validators: {
                            notEmpty: {
                                message: 'The post number is required'
                            }
                        }
                    },
                    emailID: {
    ...
    <script>
        $(function()
        {
            ...
            {
                url: "{{ URL::to('/dealer/warrantyfile/') }}",
                method : "post",
                paramName: "note_file",
                ...
                init: function()
                {
                    ...
                    this.on("removedfile", function(file)
                    {
                        ...
                        if (rmvFile)
                        {
                            ...
                            var file_name_string = hidden_file_note.join(",");
                            $('#hidden_file_images').val(file_name_string);
                            $.post("{{ URL::to('/dealer/warrantyremove/') }}", {
             ...
             var hidden_token_file = $("#hidden_token_file").val();
                $.post("{{ URL::to('/dealer/warrantygetimages/') }}", { data_warranty_uniqueID : warranty_uniqueID, _token: hidden_token_file },
                function(data)
                {
                    ...
                    for (var i in json_obj_file)
                    {
                        ...
                        var mockFile = { name: '', size: json_obj_file[i].size };
