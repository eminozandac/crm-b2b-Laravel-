				...
				<div class="ibox float-e-margins">
					...
					<div>
						<div class="ibox-content no-padding border-left-right">
							<img alt="image" style="margin: 0 auto;" class="img-responsive" src="{{asset($dealerAvatart)}}">
						</div>
						<div class="ibox-content profile-content">
							<h4> <i class="fa fa-user">&nbsp;</i><strong> {{ $dealerName }}</strong></h4>
							<p>
						    ...
						    <div class="row">
                                <form action="{{action('dealer\DealerController@updateDealerAvatar')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="tabs-container">
						...
						<div class="tab-content">
							...
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="ibox-content col-md-12">
										<div class="col-md-12">
											<form class="m-t form-horizontal"  role="form" method="post" action="{{action('dealer\DealerController@profileUpdate')}}" id="form_dealer_profile" >
												<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
													    <input type="text" class="form-control" name="company_name" id="company_name" placeholder="Company name" value="{{ $companyName }}">
                                                    </div>
												</div>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
														  <textarea class="form-control" id="address" style="height:100px;" name="address" placeholder="Billing Address" >{{ $address }}</textarea>
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-sm-3 control-label">Shipping Address</label>
                                                    <div class="col-sm-9">
														  <textarea class="form-control" id="shipping_address" name="shipping_address" style="height:100px;" placeholder="Shipping Address" >{{ $shipping_address }}</textarea>
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-sm-3 control-label">Contact person 1</label>
                                                    <div class="col-sm-9">
														  <textarea class="form-control" id=" " name="contactperson1" style="height:100px;" placeholder="Contact person 1" >{{ $contactperson1 }}</textarea>
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-sm-3 control-label">Contact person 2</label>
                                                    <div class="col-sm-9">
														  <textarea class="form-control" id=" " name="contactperson2" style="height:100px;" placeholder="Contact person 2" >{{ $contactperson2 }}</textarea>
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-sm-3 control-label">Contact person 3</label>
                                                    <div class="col-sm-9">
														  <textarea class="form-control" id=" " name="contactperson3" style="height:100px;" placeholder="Contact person 3" >{{ $contactperson3 }}</textarea>
                                                    </div>
                                                </div>
							...
							<div id="tab-2" class="tab-pane">
								<div class="panel-body">
									<div class="col-md-12">
										<form class="m-t form-horizontal" role="form" method="post" action="{{action('dealer\DealerController@passwordUpdate')}}" id="form_updatepassword" >
											<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <div class="ibox-content col-md-12">
                                        <div class="col-md-12">
                                            <form class="m-t form-horizontal"  role="form" method="post" action="{{action('dealer\DealerController@billingAddress')}}" id="dealer_billing" >
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
