                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/admin/mediacategoryfile')}}" style="background-color: #18A689;">
                        ...
                        <div class="ibox-content">
                            <form id="mediacategory_add" name="mediacategory_add" method="POST" action="{{ action('admin\MediaCategoryFileController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                        ...
                                        <select class="form-control" id="media_uniqueID" name="media_uniqueID" required>
                                            ...
                                            @if(!empty($parent_category))
                                                @foreach($parent_category as $key => $value)
                                                    <option value="{{ $value->media_uniqueID }}">{{ $value->name }}</option>
                                                    <?php
                                                    if($value->id != '')
                                                    {
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <input type="hidden" name="media_file_uniqueID" id="media_file_uniqueID" value="{{ $media_file_uniqueID }}" />
                                    </div>
                                </div>
