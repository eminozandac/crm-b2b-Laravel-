...
<?php $__env->startSection('contentPages'); ?>
		...
		<!--------------------------------invoiced--------------------------------------->
										...
										<div id="tab-1" class="tab-pane active">
											...
											<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('admin\OrderController@paidInvoice')); ?>" id="bookedinfordeliverys" >
												<div class="col-sm-4">
												...
												<div class="col-sm-6">
													<div class="form-group pull-right">
														<label class="control-label">&nbsp;</label>
														<br/>													
														<a href="<?php echo e(URL('/admin/createserviceinvoice')); ?>" class="btn btn-primary"> Create Service Invoice </a>
													</div>
													
													<div class="form-group pull-right">
														<label class="control-label">&nbsp;</label>
														<br/>													
														<a href="<?php echo e(URL('/admin/createinvoice')); ?>" class="btn btn-primary"> Create Invoice </a>&nbsp;
													&nbsp;
													</div>
...
<?php $__env->startSection('pagescript'); ?>
	...
	$(function() 
	{
		...
		var bookedorder_table = $('#bookedorder_table').DataTable({
			...
			"serverSide": true,
			"ajax": {
				url: "<?php echo e(URL::to('admin/adminorderlistbooked')); ?>",
				data: function (d) {
				}
			},
			"columns": [
