...
@section('contentPages')
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{URL::to('/staff/task')}}">Task</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="task_add" name="task_add" method="POST" action="{{ action('staff\StaffTaskController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Status..." class="form-control"  style="width: 100%;" tabindex="2" name="task_priority" id="task_priority">
                                            ...
                                            { ?>
                                            <option value="{{ $key }}"  <?php  if($task_priority_selected == $key){ echo 'selected'; } ?> >
                                                {{ $value }}
                                            </option>
                                            <?php  } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required id="assign_date"  class="form-control datetd date" placeholder="dd-mm-yyyy" name="assign_date" value="{{ $assign_date }}">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required id="completion_date"  class="form-control datetd date" placeholder="dd-mm-yyyy" name="completion_date" value="{{ $completion_date }}">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Status..." class="form-control"  style="width: 100%;" tabindex="2" name="task_status" id="task_status">
                                            ...
                                            { ?>
                                            <option value="{{ $key }}"  <?php  if($task_status_selected == $key){ echo 'selected'; } ?> >
                                                {{ $value }}
                                            </option>
                                            <?php  } ?>
                                        </select>
        ...
        <input name="_token" type="hidden" id="new_hidden_token" value="{{ csrf_token() }}"/>
		@stop()
