				...
				<div class="ibox float-e-margins">
					...
					<div>
						<div class="ibox-content no-padding border-left-right">
							<img alt="image" style="margin: 0 auto;" class="img-responsive" src="{{asset($customerAvatar)}}">
						</div>
						<div class="ibox-content profile-content">
							<h4> <i class="fa fa-user">&nbsp;</i><strong> {{ $customerName }}</strong></h4>
							<p>
                                <i class="fa fa-envelope">&nbsp;</i>
                                <strong>{{ $emailID }}</strong>
                            </p>
						    <div class="row">
                                <form action="{{action('customer\CustomerController@updateCustomerAvatar')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="tabs-container">
						...
						<div class="tab-content">
							...
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="ibox-content col-md-12">
										<div class="col-md-12">
											<form class="m-t form-horizontal"  role="form" method="post" action="{{action('customer\CustomerController@profileUpdate')}}" id="form_customer_profile" >
												<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select data-placeholder="Choose a Country..." class="country form-control"  style="width: 100%;" tabindex="2" name="country" id="country">
                                                            ...
                                                            { ?>
                                                            <option value="{{ $key }}"  <?php  if($customer_country == $key){ echo 'selected'; } ?> >
                                                                {{ $value }}
                                                            </option>
                                                            <?php  } ?>
                                                        </select>
							...
							<div id="tab-2" class="tab-pane">
								<div class="panel-body">
									<div class="col-md-12">
										<form class="m-t form-horizontal" role="form" method="post" action="{{action('customer\CustomerController@passwordUpdate')}}" id="form_updatepassword" >
											<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
