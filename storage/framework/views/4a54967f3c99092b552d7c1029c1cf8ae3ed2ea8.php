...
<div class="middle-box text-center loginscreen   animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" name="form_registration" id="form_registration" method="post" action="<?php echo e(action('customer\CustomerController@registerData')); ?>">
            ...
            <a class="btn btn-sm btn-white btn-block" href="<?php echo e(URL::to('/customer')); ?>">Login</a>
