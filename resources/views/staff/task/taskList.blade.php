                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/staff/taskadd')}}"  style="background-color: #18A689;">
                                                    ...
                                                    @if(isset($task_list_pending) && !empty($task_list_pending))
                                                        @foreach($task_list_pending as $key => $value)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>@if($taks_assign_user != '---' || $taks_assign_user != '')<span class="badge {{ $role_assign_class }}">{{ $role_assign }}</span>@endif {{ $taks_assign_user }}</td>
                                                                <td>@if($taks_assigned_by != '---' || $taks_assigned_by != '')<span class="badge {{ $role_create_class }}">{{ $role_create }}</span>@endif {{ $taks_assigned_by }}</td>
                                                                <td>
                ...
                $(function ()
                {
                    ...
                    function allApprove(val_status)
                    {
                        ...
                        if(chk_Array.length != 0){
                            $.ajax({
                                type:'POST',
                                url: "{{ URL::to('staff/ajax/log/taskstatuschange') }}",
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "{{ URL::to('staff/ajax/log/taskdelete') }}",
