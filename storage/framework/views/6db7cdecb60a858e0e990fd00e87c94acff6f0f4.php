        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/staff/warranty')); ?>">All Warranty Report</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/staff/warrantyadd')); ?>"  style="background-color: #18A689;">
                                                ...
                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="warranty_table" >
                                                    ...
                                                    <?php if(!empty($warrantyList_pending)): ?>
                                                        <?php foreach($warrantyList_pending as $key => $value): ?>
                                                            ...
                                                            $url_edit = "";
                                                            $url_edit = "/staff/warrantyedit/".$value->warranty_uniqueID;

                                                            $url_pdf = "";
                                                            $url_pdf = "/staff/warrantypdf/".$value->warranty_uniqueID;

                                                            $url_print = "";
                                                            $url_print = "/staff/warrantyprint/".$value->warranty_uniqueID;
            ...
            <script type="text/javascript">
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "<?php echo e(URL::to('staff/ajax/log/warrantydelete')); ?>",
                ...
                function datanoteWarranty(uniqueID)
                {
                    if(uniqueID != 0 && uniqueID != '')
                    {
                        ...
                        ({
                            type: "POST",
                            url: "<?php echo e(URL::to('staff/ajax/log/warrantynote')); ?>",
