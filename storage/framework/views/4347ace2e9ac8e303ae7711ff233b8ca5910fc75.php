...
<?php $__env->startSection('contentPages'); ?>
                ...
                <div class="col-md-12">
                    <div class="ibox">
						...
						<div class="ibox-content" <?php if($invoice->serviceInvoice==1){echo 'style="display:none;"';} ?>>
							...
							<form action="<?php echo e(action('admin\OrderController@adminOrderInvoiceUpdate')); ?>" method="POST" enctype="multipart/form-data" class="productss" id="order_edit">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="submit" class="btn btn-w-m btn-primary" id="stockupdate" value="Update" />
										 <a href="<?php echo e(URL::to('/admin/invoicelist')); ?>" class="btn btn-default pull-right"><i class="fa fa-arrow-left"></i> Back</a>
									</div>
								</div>
							</form>
								<div class="clearfix"></div>
		...
		<!--------------------------------invoiced--------------------------------------->
										...
										<div id="tab-3" class="tab-pane active">
											...
											<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('admin\OrderController@generateServiceInvoiceDataUpdate')); ?>" id="order_edit" enctype="multipart/form-data">
