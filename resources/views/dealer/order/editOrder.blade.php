...
@section('contentPages')
            ...
            <div class="row">
                <div class="col-md-9">
					<div class="ibox">
					<form action="{{action('dealer\OrderController@updateorder')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <tr>
                                        ...
                                        <td class="desc" width="120"> 
                                            ...
                                            <div class="m-t-sm">
                                                ...
                                                <a href="{{URL::to($removeitm)}}" class="text-muted" style="color:Red;"><i class="fa fa-times" aria-hidden="true"></i> Cancel order</a>
                                            </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <a href="{{URL::to('/dealer/orders')}}" class="btn btn-white"><i class="fa fa-arrow-left"></i> Cancel</a>
                        </div>
					</form>
                    </div>
                </div>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="m-t-sm">
								...
								?>
                                <a href="{{URL::to('/dealer/checkout/')}}" class="btn btn-primary btn-sm"><i class="fa fa-shopping-cart"></i> Checkout</a>
								 <?php }?>
