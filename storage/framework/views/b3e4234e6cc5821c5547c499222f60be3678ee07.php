...
<body>
    <div id="wrapper">
		<nav class="navbar-default navbar-static-side" role="navigation">
			<?php echo $__env->make('customer.includes.sidebarmenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	    </nav>
			...
			<div class="row border-bottom">
				<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
					...
					<ul class="nav navbar-top-links navbar-right">
                        <li>
							<a class="count-info" title="User Profile" href="<?php echo e(action('customer\CustomerController@profile')); ?>">
								<i class="fa fa-user" aria-hidden="true"></i>
							</a>
						</li>
						<li>
							<a title="Logout" href="<?php echo e(action('customer\CustomerController@logout')); ?>">
