        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="<?php echo e(action('employee\EmployeeController@profile')); ?>">Profile</a></li>
                            <li><a href="<?php echo e(action('employee\EmployeeController@logout')); ?>">Logout</a></li>
                        </ul>
                    </div>
                ...
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('employee\EmployeeController@index')); ?>">
                ...
                ?>
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('employee\EmployeeTaskController@index')); ?>">
                ...
                ?>
                <li class="<?php echo e($activeClass); ?>">
                    <a href="<?php echo e(action('employee\EmployeeCalenderController@index')); ?>">
                ...
                <li class="<?php echo $activeClass; ?>">
                    <a href="<?php echo e(URL::to('employee/warranty')); ?>"><i class="fa fa-recycle" aria-hidden="true"></i> <span class="nav-label">Warranty</span></a>
                </li>
