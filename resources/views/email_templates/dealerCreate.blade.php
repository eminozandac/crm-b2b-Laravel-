...
Hello, <strong>'.$data_dealer["first_name"].'</strong> Your Login Details</h4>
</th>
...
<b>Full Name : </b> '.$data_dealer["first_name"].'  '.$data_dealer["last_name"].'
</p>
<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<b>Company Name : </b> '.$data_dealer["company_name"].'
</p>
<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<b>Email ID : </b> '.$data_dealer["emailID"].'
</p>
<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<b>New Password : </b> '.$data_dealer["password"].'
</p>

<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<a href="'.$data_dealer["loginUrl"].'"><b>Login</b></a>
</p>
<hr />
<br />
