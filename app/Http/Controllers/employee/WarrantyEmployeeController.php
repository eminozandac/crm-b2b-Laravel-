...
class WarrantyEmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            $data['total_pending_warranty'] = WarrantyProduct::select('id')->where('assign_role','=','employee')->where('warranty_assign','=',$sessionData['unique_ID'])->where('warranty_status','!=','complete')->orderBy('id','DESC')->count();
            $data['total_complete_warranty'] = WarrantyProduct::select('id')->where('assign_role','=','employee')->where('warranty_assign','=',$sessionData['unique_ID'])->where('warranty_status','=','complete')->orderBy('id','DESC')->count();

            $result_warrantyList = WarrantyProduct::select('*')->where('assign_role','=','employee')->where('warranty_assign','=',$sessionData['unique_ID'])->where('warranty_status','!=','complete')->orderBy('id','DESC')->get();
            ...
            return View::make('warranty/employee/employeeWarrantyList',$data);
        }else{
    ...
    public function warrantyAdd()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            return View::make('warranty/employee/employeeWarrantyAdd',$data);
        }else{
        ...
        if(isset($id) && ($id != 0))
        {
                ...
                && (($data_post['method_process'] == 'add') || ($data_post['method_process'] == 'edit')) )
            {
                ...
                if ($validator->fails())
                {
                    ...
                    return Redirect::to('/employee/warrantyadd');
                }else
                {
                    $update_post = array();
                    ...
                    if(!empty($primary_key))
                    {
                        ...
                        if(!empty($result_warranty_product))
                        {
                            ...
                            if(!empty($staff_emailID_result))
                            {
                                ...
                                $warranty_info = array(
                                    'title_message' => 'Employee Change Warranty Product Details',
                                    'to_name' => $assign_name,
                                    'name' => $update_post['name'],
                                    'emailID' => $update_post['emailID'],
                                    'product_model' => $update_post['product_model'],
                        ...
                        return Redirect::to('/employee/warranty');
                    }else{
                        Session::flash('operationFaild','Some thing went wrong!');
                        if($data_post['method_process'] == 'add')
                        {
                        ...
                        {
                            return Redirect::to('/employee/warrantyedit/'.$data_post['warranty_uniqueID']);
                        }else{
                            return Redirect::to('/employee/warranty');
                        }
                    }
    ...
    public function warrantyEdit($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result)){
                ...
                return View::make('warranty/employee/employeeWarrantyEdit',$data);
            }else{
                return Redirect::to('employee/warranty');
            }
        }else{
    ...
    public function warrantyPDF($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            {
                $data['warrantyData'] = $result;
                $data['return_url'] = URL::to('employee/warranty');
                ...
                $pdf = PDF::loadView('warranty/employee/pdfFormate', $data);
    ...
    public function warrantyPrint($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result))
            {
                ...
                return View::make('warranty/employee/pdfFormate',$data);
    ...
    public function noteDataForm()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result))
            {
                ...
                return View::make('warranty/employee/noteWarranty',$data);
            }else{
                echo '444';
                exit;
            }
