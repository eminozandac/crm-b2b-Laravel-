        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{URL::to('/admin/grouplist')}}">All Group</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/admin/groupadd')}}"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                ...
                $(function (){
                    ...
                    var group_table = $('#group_table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            url: "{{ URL::to('admin/ajax/log/groupdata') }}",
                            data: function (d) {
                            }
                        },
                        "columns": [
                    ...
                    function deleted(id)
                    {
                        ...
                        function(isConfirm){
                            if (isConfirm)
                            {
                                ...
                                ({
                                    type: "POST",
                                    url: "{{ URL::to('admin/ajax/log/groupdelete') }}",
