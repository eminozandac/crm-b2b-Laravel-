<?php
    $count_today_task = 0;
    $today_task = Session::get('employeeTodaytask');
    $count_today_task = count($today_task);

    $today_task_list_data = Session::get('employeeTodaytask_list');
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title>Inventory CRM | Employee </title>
...
<body>
    <div id="wrapper">
		<nav class="navbar-default navbar-static-side" role="navigation">
			<?php echo $__env->make('employee.includes.sidebarmenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	    </nav>
			...
			<div class="row border-bottom">
				<nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
					...
					<ul class="nav navbar-top-links navbar-right">
                                    ...
                                    <?php foreach($today_task as $key_today_task => $value_today_task): ?>
                                        <li>
                                            <a href="javascript:void(0);" onclick="displayAssignTask('<?php echo e('notificationlist_'.$no); ?>')" id="notificationlist_<?php echo e($no); ?>" data-title="<?php echo e($today_task_list_data[$no]['title']); ?>"  data-assigndate="<?php echo e($today_task_list_data[$no]['assign_date']); ?>"
                                               data-completiondate="<?php echo e($today_task_list_data[$no]['completion_date']); ?>" data-taskassign="<?php echo e($today_task_list_data[$no]['task_employee']); ?>"
                        ...
                        <li>
							<a class="count-info" title="User Profile" href="<?php echo e(action('employee\EmployeeController@profile')); ?>">
								<i class="fa fa-user" aria-hidden="true"></i>
							</a>
						</li>
						<li>
							<a title="Logout" href="<?php echo e(action('employee\EmployeeController@logout')); ?>">
