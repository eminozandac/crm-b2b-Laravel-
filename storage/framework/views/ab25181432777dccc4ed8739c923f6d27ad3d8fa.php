        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/admin/warranty')); ?>">All Warranty Report</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/admin/warrantyadd')); ?>"  style="background-color: #18A689;">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#warranty_pending">Pending (<?php echo e($total_pending_warranty); ?>)</a></li>
                                    <li class=""><a data-toggle="tab" href="#warranty_complete">Complete (<?php echo e($total_complete_warranty); ?>)</a></li>
                                </ul>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="warranty_table" >
                                                    ...
                                                    <tbody>
													<?php 
													/*  $getDatawar=DB::table('warrantyproduct')->get();
													$ClaimNumber=295000;
													foreach($getDatawar as $war){
														$ClaimNumber++;
														$updatewarrenty=array(
															'claimNumber'=>$ClaimNumber
														);
													$updateData=DB::table('warrantyproduct')->where('id','=',$war->id)->update($updatewarrenty);
													} 	 */
													?> 
                                                    <?php if(!empty($warrantyList_pending)): ?>
														<?php //$ClaimNumber=295000; ?>
                                                        <?php foreach($warrantyList_pending as $key => $value): ?>
                                                            <?php
															//$ClaimNumber++;
                                                            ...
                                                            $url_edit = "";
                                                            $url_edit = "/admin/warrantyedit/".$value->warranty_uniqueID;

                                                            $url_pdf = "";
                                                            $url_pdf = "/admin/warrantypdf/".$value->warranty_uniqueID;

                                                            $url_print = "";
                                                            $url_print = "/admin/warrantyprint/".$value->warranty_uniqueID;
                                                            ...
                                                            if($value->role == 'customer')
                                                            {
                                                                ...
                                                                {
                                                                    $name = $result->first_name.' '.$result->last_name;
                                                                    $companyName = $result->first_name.' '.$result->last_name;
                                                                }else{
                                                                    $name = '---';
                                                                    $companyName = '---';
                                                                }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($value->claimNumber); ?></td>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="warranty_table" >
                                                    ...
                                                    <tbody>
                                                    <?php if(!empty($warrantyList_complete)): ?>
                                                        <?php foreach($warrantyList_complete as $key => $value): ?>
                                                            <?php
                                                            $status = $status_color = '';
                                                            $config_status = 'warranty.WARRANTY_STATUS.'.$value->warranty_status;
                                                            $status = Config::get($config_status);
            ...
            <script type="text/javascript">
                ...
                $(function ()
                {
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "<?php echo e(URL::to('admin/ajax/log/warrantydelete')); ?>",
                    ...
                    function datanote_Warranty(uniqueID)
                    {
                        ...
                        ({
                            type: "POST",
                            url: "<?php echo e(URL::to('admin/ajax/log/warrantynote')); ?>",
