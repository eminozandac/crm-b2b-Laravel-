                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/staff/taskadd')); ?>"  style="background-color: #18A689;">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab_pending">Pending (<?php echo e(count($task_list_pending)); ?>)</a></li>
                                    <li class=""><a data-toggle="tab" href="#tab_complete">Complete (<?php echo e(count($task_list_complete)); ?>)</a></li>
                                </ul>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="task_pending" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="min-width: 130px;">Assign User</th>
                                                    ...
                                                    <?php if(isset($task_list_pending) && !empty($task_list_pending)): ?>
                                                        <?php foreach($task_list_pending as $key => $value): ?>
                                                            <?php
                                                            $taks_assign_role  = '';
                                                            $taks_assign_role  = strtoupper($value->role);

                                                            $taks_assign_user = $taks_assigned_by = '';
                                                            $role_assign = $role_assign_class = '';
                                                            if($value->task_assign != '')
                                                            {
                                                                $staffname = '';
                                                                $staffname_ar = array();
                                                                $staff_ar = explode(',',$value->task_assign);
                                                                ...
                                                                {
                                                                    $taks_assign_user = implode(',',$staffname_ar);
                                                                    $taks_assign_role  = strtoupper($value->role);
                                                                }else{
                                                                    $taks_assign_user =  '---';
                                                                    $taks_assign_role =  '---';
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php if($taks_assign_user != '---' || $taks_assign_user != ''): ?><span class="badge <?php echo e($role_assign_class); ?>"><?php echo e($role_assign); ?></span><?php endif; ?> <?php echo e($taks_assign_user); ?></td>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    $url = URL::to('staff/edit-task', $value->task_id);
                                                                    $html = "";
        ...
        <?php $__env->startSection('pagescript'); ?>
            ...
            <script type="text/javascript">
                ...
                $(function ()
                {
                    ...
                    var task_pending = $('#task_pending').DataTable({
                    ...
                    var task_complete = $('#task_complete').DataTable({
                        "aoColumnDefs": [ { "bSortable": true, "aTargets": [ 1,5 ] } ],
                        "iDisplayLength": 20,
                        "aLengthMenu": [[10, 20, 30, 50, 100, 200, 500, -1], [10, 20, 30, 50, 100, 200, 500, "All"]],
                        "columns": [
                    ...
                    function allApprove(val_status)
                    {
                        ...
                        if(chk_Array.length != 0){
                            $.ajax({
                                type:'POST',
                                url: "<?php echo e(URL::to('staff/ajax/log/taskstatuschange')); ?>",
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "<?php echo e(URL::to('staff/ajax/log/taskdelete')); ?>",
