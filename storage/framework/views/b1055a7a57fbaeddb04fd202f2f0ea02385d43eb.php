...
<?php $__env->startSection('contentPages'); ?>
            ...
            <div class="row">
			<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('dealer\OrderController@placeOrderCheckout')); ?>" id="customer_billing" >
                <div class="col-md-9">
					<div class="ibox">
						...
						?> 
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!--<select class="form-control addressType" name="addressType" id="addressType_<?php echo e($i); ?>" 
									onchange="loadAddressType('<?php echo e($i); ?>')" >
									...
									<div class="col-sm-12">
										<div class="form-group">
										 <label class="control-label">&nbsp;</label>
										     <div class="i-checks"><label> <input type="radio" id="addressType_<?php echo e($i); ?>" onclick="loadAddressType('<?php echo e($i); ?>')" data-box="addressbox_<?php echo $i; ?>" data-def="defaultAddress_<?php echo $i; ?>"   value="default" checked="checked" name="addressType_<?php echo e($i); ?>[]"> <i></i> Deliver to this address</label></div>
									...
									<div class="col-sm-12">
										<div class="form-group">
										     <div class="i-checks"><label> <input type="radio" id="addressType_<?php echo e($i); ?>" onclick="loadAddressType('<?php echo e($i); ?>')"  data-box="addressbox_<?php echo $i; ?>" data-def="defaultAddress_<?php echo $i; ?>" value="other" name="addressType_<?php echo e($i); ?>[]"> <i></i> Deliver to diffrent address </label></div>
		 ...
		 var config = {
			...
			function accessoryaddplaceordertime()
			{
				...
				if(newaccessory.length > 0 || accesoryedit_ar.length > 0)
				{
					...
					({
						type: "POST",
						url: "<?php echo e(URL::to('dealer/ajax/log/placeorderaccessories')); ?>",
				...
				//console.log(accssory);
					...
					function(isConfirm){
						if (isConfirm) {
							...
							({
								type: "POST",
								url: "<?php echo e(URL::to('dealer/ajax/log/placeorderaccessoriesremove')); ?>",
