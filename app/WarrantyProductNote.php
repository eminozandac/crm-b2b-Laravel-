...
class WarrantyProductNote extends Model {

    public $timestamps=true;
    protected $dates = ['deleted_at'];

    protected $table = 'warrantyproduct_note';

    protected $hidden = array('password', 'remember_token');

    protected $primaryKey = ['warranty_note_uniqueID']; // or null

    public $incrementing = false;

    protected $fillable = ['warranty_note_uniqueID', 'warranty_uniqueID', 'role', 'user_id', 'note', 'created_at', 'updated_at', 'deleted_at'];

    protected $rules=[
        'warranty_note_uniqueID'=>'required'
    ];
