	...
	<body class="gray-bg">
		<div class="middle-box text-center loginscreen animated fadeInDown">
			<div class="col-md-12">
				...
				<form class="m-t form-horizontal" role="form" method="post" action="{{action('employee\EmployeeController@loginform')}}" id="formLogin" >
				...
				<form class="m-t form-horizontal" role="form" method="post" action="{{action('employee\EmployeeController@forgotPasswordEmployee')}}" id="formForgot" style="display:none;">
					<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
					<div class="form-group">
						<input type="email" class="form-control" name="emailID" id="emailID" placeholder="Email" required="">
					</div>
