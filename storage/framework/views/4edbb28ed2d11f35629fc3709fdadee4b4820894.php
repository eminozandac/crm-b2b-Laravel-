				...
				<div class="ibox float-e-margins">
					...
					<div>
						<div class="ibox-content no-padding border-left-right">
							<img alt="image" style="margin: 0 auto;" class="img-responsive" src="<?php echo e(asset($staffAvatart)); ?>">
						</div>
						<div class="ibox-content profile-content">
							<h4> <i class="fa fa-user">&nbsp;</i><strong> <?php echo e($staffName); ?></strong></h4>
							<p>
                                <i class="fa fa-envelope">&nbsp;</i>
                                <strong><?php echo e($emailID); ?></strong>
                            </p>
						    <div class="row">
                                <form action="<?php echo e(action('staff\StaffController@updateStaffAvatar')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <label class="control-label" for="order_id">&nbsp;</label><br/>
                                            <label title="Upload image file" for="inputImage" class="btn btn-primary">
                                                <input type="file" accept="image/*" name="staffAvatar" required id="inputImage" class="hide">
                                                Upload new image
                                            </label>
                                        </div>
                                    </div>
					...
					<div class="tabs-container">
						...
						<div class="tab-content">
							...
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="ibox-content col-md-12">
										<div class="col-md-12">
											<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('staff\StaffController@profileUpdate')); ?>" id="form_staff_profile" >
												<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>

                                                <input name="staff_id" type="hidden" id="staff_id" value="<?php echo e($staff_id); ?>"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select data-placeholder="Choose a Country..." class="country form-control"  style="width: 100%;" tabindex="2" name="country" id="country">
                                                            ...
                                                            { ?>
                                                            <option value="<?php echo e($key); ?>"  <?php  if($staff_country == $key){ echo 'selected'; } ?> >
                                                                <?php echo e($value); ?>
							...
							<div id="tab-2" class="tab-pane">
								<div class="panel-body">
									<div class="col-md-12">
										<form class="m-t form-horizontal" role="form" method="post" action="<?php echo e(action('staff\StaffController@passwordUpdate')); ?>" id="form_updatepassword" >
											<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
...
<?php $__env->startSection('pagescript'); ?>
		...
		<script type="text/javascript">
            $(function () {
                ...
                $('#form_staff_profile').formValidation({
                    framework: 'bootstrap',
                    excluded: ':disabled',
