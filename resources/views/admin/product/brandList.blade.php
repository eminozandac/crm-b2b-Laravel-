...
@section('contentPages')
        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="ibox-content m-b-sm border-bottom">
				<form action="{{action('admin\ProductController@addBrand')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								?>
									<tr>
										...
										<?php 
										   ...
										   <img alt="image" class="img-circles tbl-listing-img" src="{{asset($cavatar)}}">
										</td>
										<td>
										...
										<td class="text-right">
											<div class="btn-group">
												<a href="{{URL::to($url)}}" class="btn-white btn btn-xs">Edit</a>
												<a href="{{URL::to($urldel)}}" class="btn-white btn btn-xs">Delete</a>
											</div>
