                    ...
                    <div class="tabs-container">
						...
						<div class="tab-content">
							<div class="panel-body">
								<form action="<?php echo e(action('admin\ProductController@addProductsVariationDirect')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontalssffg" id="variationData">
