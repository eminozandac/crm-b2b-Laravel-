                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/admin/customeradd')); ?>"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                ...
                $(function ()
                {
                    ...
                    var customer_table = $('#customer_table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            url: "<?php echo e(URL::to('admin/ajax/log/customerdata')); ?>",
                            data:function(d){  }
                        },
                        "columns": [
                    ...
                    function deleted(id)
                    {
                        ...
                        function(isConfirm){
                            if (isConfirm)
                            {
                                ...
                                ({
                                    type: "POST",
                                    url: "<?php echo e(URL::to('admin/ajax/log/customerdelete')); ?>",
