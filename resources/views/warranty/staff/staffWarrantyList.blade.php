        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{URL::to('/staff/warranty')}}">All Warranty Report</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/staff/warrantyadd')}}"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "{{ URL::to('staff/ajax/log/warrantydelete') }}",
                ...
                function datanoteWarranty(uniqueID)
                {
                    if(uniqueID != 0 && uniqueID != '')
                    {
                        ...
                        ({
                            type: "POST",
                            url: "{{ URL::to('staff/ajax/log/warrantynote') }}",
