                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="mediacategory_add" name="mediacategory_add" method="POST" action="{{ action('admin\MediaSubCategoryController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
