                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="{{ action('employee\WarrantyEmployeeController@warrantySaveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="control-label">{{ strtoupper($warrantyData->assign_role) }}</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" value="{{ $warrantyData->warranty_assign }}"  name="warranty_assign">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
        ...
        $(function()
        {
            ...
            var myDropzone = new Dropzone("div#file_note",
            {
             ...
             var hidden_token_file = $("#hidden_token_file").val();
                $.post("{{ URL::to('/staff/warrantygetimages/') }}", { data_warranty_uniqueID : warranty_uniqueID, _token: hidden_token_file },
                function(data)
                {
