                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Change Employee Password</h5>
                        ...
                        <div class="ibox-content">
                            <form id="change_password" name="change_password" method="POST" action="<?php echo e(action('admin\ManageEmployeeController@updatePassworddata')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">

                                <input name="_token" type="hidden" id="hidden_token" value="<?php echo e(csrf_token()); ?>"/>
                                <input name="id" type="hidden" id="id" value="<?php echo e($employee->id); ?>"/>
                                <input name="employee_id" type="hidden" id="employee_id" value="<?php echo e($employee->employee_id); ?>"/>


                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Employee Name</label>
                                    <div class="col-sm-10">
                                        <label class="control-label"><?php echo e($employee->first_name.' '.$employee->last_name); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="control-label"><?php echo e($employee->emailID); ?></label>
                                        <input type="hidden" name="emailID" value="<?php echo e($employee->emailID); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
