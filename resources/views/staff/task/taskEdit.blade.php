                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="task_edit" name="task_edit" method="POST" action="{{ action('staff\StaffTaskController@editData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" value="employee" id="rbtn_employee" name="role" {{ $checked }}> Employee
                                            </label>
                                        </div>
                                    </div>
                                </div>
            ...
            <script type="text/javascript">
                ...
                $(function ()
                {
                    ...
                    function getAssignUser()
                    {
                        ...
                        var selected_user = '{{ $task->	task_assign }}';
