                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="<?php echo e(action('dealer\WarrantyDealerController@warrantySaveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="emailID" name="emailID" placeholder="john@mail.com" value="<?php echo e($warrantyData->emailID); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
        ...
        $(function()
        {
            ...
            var myDropzone = new Dropzone("div#file_note",
            {
             ...
             var hidden_token_file = $("#hidden_token_file").val();
                $.post("<?php echo e(URL::to('/dealer/warrantygetimages/')); ?>", { data_warranty_uniqueID : warranty_uniqueID, _token: hidden_token_file },
                function(data)
                {
