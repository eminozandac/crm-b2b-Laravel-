                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/dealer/taskadd')); ?>"  style="background-color: #18A689;">
                ...
                $(function ()
                {
                    ...
                    function allApprove(val_status)
                    {
                        ...
                        if(chk_Array.length != 0){
                            $.ajax({
                                type:'POST',
                                url: "<?php echo e(URL::to('dealer/ajax/log/taskstatuschange')); ?>",
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "<?php echo e(URL::to('dealer/ajax/log/taskdelete')); ?>",
