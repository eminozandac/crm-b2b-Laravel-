                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="mediacategory_edit" name="mediacategory_edit" method="POST" action="<?php echo e(action('admin\MediaCategoryController@editData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <label class="checkbox-inline i-checks">
                                            <input type="checkbox" value="1" id="show_all" name="show_all" <?php echo e($checked); ?> > Show All Dealer
                                        </label>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        ?>
                                        <input type="checkbox" class="js-switch_2" name="status" id="status" value="<?php echo e($mediacategory->status); ?>" <?php echo $checked; ?> />
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
