...
class MediaCategory extends Model {
    ...
    protected $primaryKey = ['media_uniqueID']; // or null

    public $incrementing = false;

    protected $fillable = ['media_uniqueID', 'parent_id', 'name', 'dealer_id', 'old_file_name', 'file_name', 'status', 'created_at', 'updated_at', 'deleted_at'];

    protected $rules=[
        'media_uniqueID'=>'required'
    ];
