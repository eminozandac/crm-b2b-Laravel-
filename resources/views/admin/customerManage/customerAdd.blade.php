                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="customer_add" name="customer_add" method="POST" action="{{ action('admin\ManageCustomerController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
