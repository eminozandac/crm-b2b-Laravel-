                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="task_edit" name="task_edit" method="POST" action="<?php echo e(action('employee\EmployeeTaskController@editData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
