...
class AdminOrderNotes extends Model {
 	 
	public $timestamps=true;
    protected $dates = ['deleted_at'];

    protected $table = 'admin_order_notes';

    protected $hidden = array('password', 'remember_token');

    protected $primaryKey = ['orderTokenString']; // or null

    public $incrementing = false;

    protected $fillable = ['orderTokenString','orderID','product_id','name','description','created_at','updated_at'];

    protected $rules=[
        'admin_order_notesID'=>'required'
    ];
