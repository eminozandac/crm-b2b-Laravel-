                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block" style="padding: 0 0 20px;">
                                       <p><strong>Product Name : </strong>{{$data_user_stocck_update['productName']}}</p>
                                       <p><strong>Color : </strong>{{$data_user_stocck_update['color']}}</p>
                                       <p><strong>Batch : </strong>{{$data_user_stocck_update['batch']}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" style="padding: 0 0 20px;">
                                       <p><strong>Note : </strong></p>
									   <p>{{$data_user_stocck_update['notes']}}</p>
