...
@section('contentPages')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="{{URL::to('/employee/dashboard')}}">Home</a>
                </li>
                <li class="active">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class="btn btn-w-m btn-primary" href="{{URL::to('/employee/warranty')}}"  style="background-color: #18A689;">
                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="{{ action('employee\WarrantyEmployeeController@warrantySaveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
...
@section('pagescript')
    ...
    <script>
        $(function()
        {
            ...
            {
                url: "{{ URL::to('/employee/warrantyfile/') }}",
                method : "post",
                paramName: "note_file",
                ...
                init: function()
                {
                    ...
                    this.on("removedfile", function(file)
                    {
                        ...
                        if (rmvFile)
                        {
                            ...
                            var file_name_string = hidden_file_note.join(",");
                            $('#hidden_file_images').val(file_name_string);
                            $.post("{{ URL::to('/employee/warrantyremove/') }}", {
        ...
        $(function (){
            ...
            function getUserName(role)
            {
                ...
                if((role != 'customer') || (role == 'dealer'))
                {
                    ...
                    ({
                        type: "POST",
                        url: "{{ URL::to('employee/ajax/log/getusers') }}",
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            function getAssignUser()
            {
                ...
                ({
                    type: "POST",
                    url: "{{ URL::to('employee/ajax/log/getassignuser') }}",
