...
<?php $__env->startSection('contentPages'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="<?php echo e(URL::to('/employee/dashboard')); ?>">Home</a>
                </li>
                <li class="active">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/employee/warranty')); ?>"  style="background-color: #18A689;">
                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="<?php echo e(action('employee\WarrantyEmployeeController@warrantySaveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="control-label"><?php echo e(strtoupper($warrantyData->assign_role)); ?></label>
                                    <input type="hidden" value="employee"  name="assign_role">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        $name = '';
                                        $result = DB::table('employee')->where('employee_id','=',$warrantyData->warranty_assign)->first();
                                        if(!empty($result)){
                                            $name = $result->first_name.' '.$result->last_name;
                                        }
                                    ?>
                                    <label class="control-label"><?php echo e($name); ?></label>
                                    <input type="hidden" value="<?php echo e($warrantyData->warranty_assign); ?>"  name="warranty_assign">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="control-label"><?php echo e(strtoupper($warrantyData->role)); ?></label>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="warranty_status" id="warranty_status">
                                        <?php if(!empty($warranty_status)): ?>)
                                            <?php foreach($warranty_status as $key => $value): ?>
                                                <?php
                                                    $selected = '';
                            ...
                            <div class="form-group" id="div_customer_name">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" required name="name" id="name" value="<?php echo e($warrantyData->name); ?>" placeholder="john"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="address" name="address"><?php echo e($warrantyData->address); ?></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="postcode" name="postcode" placeholder="" value="<?php echo e($warrantyData->postcode); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                                    Customer's EmailID
                                    <?php if($warrantyData->role == 'customer'): ?>
                                        <span class="help-block m-b-none span_help" style="color:#f8ac59;">(login-username)</span>
                                    <?php endif; ?>
                                </label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control contactMethod" id="emailID" name="emailID" placeholder="john@mail.com" value="<?php echo e($warrantyData->emailID); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control contactMethod" id="phone" name="phone" placeholder="1234" value="<?php echo e($warrantyData->phone); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="product_model" name="product_model" placeholder="Hot tub" value="<?php echo e($warrantyData->product_model); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea  class="form-control" id="product_fault" name="product_fault"><?php echo e($warrantyData->product_fault); ?></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="part_require" name="part_require" placeholder="" value="<?php echo e($warrantyData->part_require); ?>" />
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <input type="hidden" name="role" id="role" value="<?php echo e($warrantyData->role); ?>" />
                                    <input type="hidden" name="user_id" id="user_id" value="<?php echo e($warrantyData->user_id); ?>" />
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php $__env->startSection('pagescript'); ?>
    ...
    <script>
        $(function()
        {
            ...
            {
                url: "<?php echo e(URL::to('/staff/warrantyfile/')); ?>",
                method : "post",
                paramName: "note_file",
                ...
                init: function()
                {
                    ...
                    this.on("removedfile", function(file)
                    {
                        ...
                        if (rmvFile)
                        {
                            ...
                            var file_name_string = hidden_file_note.join(",");
                            $('#hidden_file_images').val(file_name_string);
                            $.post("<?php echo e(URL::to('/staff/warrantyremove/')); ?>", {
             ...
             var hidden_token_file = $("#hidden_token_file").val();
                $.post("<?php echo e(URL::to('/staff/warrantygetimages/')); ?>", { data_warranty_uniqueID : warranty_uniqueID, _token: hidden_token_file },
                function(data)
                {
    ...
    <script type="text/javascript">
        ...
        $(function ()
        {
            ...
            function getAssignUser()
            {
                ...
                var selected_user = '<?php echo e($warrantyData->warranty_assign); ?>';
