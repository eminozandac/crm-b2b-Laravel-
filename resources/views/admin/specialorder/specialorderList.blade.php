        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{URL::to('/admin/specialorderslist')}}">All Special Order List</a>
                    </li>
                </ol>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" id="specialorder_table" >
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 62px;">Order Date</th>
												...
												<td>
													<?php 
														if($spOrder->product_color != '')
														{
															...
															if(!empty($spOrder->product_side_color)){
																...
																echo $spOrder->product_color .'( with '.$coloesidejson[$spOrder->product_side_color].' sides)';
															}else{
                ...
                $(function (){
                    ...
                    var customer_table = $('#specialorder_table').DataTable({
                       ...
                       /*  "processing": true,
                        "serverSide": true,
                        "ajax": {
                            url: "{{ URL::to('admin/ajax/log/specialdata') }}",
                            data:function(d){  }
                        },
                        "columns": [
							...
							swal({
								...
								function(isConfirm){
									if (isConfirm)
									{
										...
										({
											type: "POST",
											url: "{{ URL::to('admin/ajax/log/specialorderdelete')}}",
