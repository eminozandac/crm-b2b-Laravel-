...
Hello, <strong>'.$data_info["first_name"].'</strong> Your Login Details</h4>
</th>
...
<b>Full Name : </b> '.$data_info["first_name"].'  '.$data_info["last_name"].'
</p>
<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<b>Email ID : </b> '.$data_info["emailID"].'
</p>
<p  style="text-align: center;font-size: 14px;line-height: 19px;font-weight: normal; ">
<b>New Password : </b> '.$data_info["password"].'
</p>
