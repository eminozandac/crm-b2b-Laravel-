...
<table class="body-wrap" style="    background-color: #f6f6f6;
    ...
    text-align: center;
    border-radius: 3px 3px 0 0;">
                            Its Easy to recover your password, {{$data_user_password_mail['first_name']}} !
                        </td>
                    </tr>
                    <tr>
                        <td class="content-wrap" style="padding: 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block" style="padding: 0 0 20px;">
                                       <p><strong>user name : </strong> {{$data_user_password_mail['email']}}</p>
                                       <p><strong>Temp. Password</strong> {{$data_user_password_mail['password']}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" style="padding: 0 0 20px;">
                                        <a href="{{ URL::to('admin')}}" class="btn-primary" style="text-decoration: none;
    color: #FFF;
    background-color: #1ab394;
    border: solid #1ab394;
    border-width: 5px 10px;
