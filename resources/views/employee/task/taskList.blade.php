                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/employee/taskadd')}}"  style="background-color: #18A689;">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab_pending">Pending ({{ $total_pending_task }})</a></li>
                                    <li class=""><a data-toggle="tab" href="#tab_complete">Complete ({{ $total_complete_task }})</a></li>
                                </ul>
                ...
                $(function ()
                {
                    ...
                    function allApprove(val_status)
                    {
                        ...
                        if(chk_Array.length != 0){
                            $.ajax({
                                type:'POST',
                                url: "{{ URL::to('employee/ajax/log/taskstatuschange') }}",
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "{{ URL::to('employee/ajax/log/taskdelete') }}",
