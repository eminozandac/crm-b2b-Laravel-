                        ...
                        <form id="warranty_form" name="warranty_form" method="POST" action="<?php echo e(action('staff\WarrantyStaffController@warrantySaveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div>
                                        <label>
                                            <input type="radio" value="dealer" id="rbtn_dealer" name="role" checked> Dealer
                                        </label>
                                    </div>
                                    <div>
                                        <label>
                                            <input type="radio" value="customer" id="rbtn_customer" name="role"> Customer
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="div_customer_name">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" required name="name" id="name" value="" placeholder="john"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email"  class="form-control contactMethod" id="emailID" name="emailID" placeholder="john@mail.com">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  class="form-control contactMethod"  id="phone" name="phone" placeholder="1234">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  class="form-control" id="product_model" name="product_model" placeholder="Hot tub"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea  class="form-control" id="product_fault" name="product_fault"></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"  class="form-control" id="part_require" name="part_require" placeholder="">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
        ...
        $(function (){
            ...
            function getUserName(role)
            {
                ...
                if((role != 'customer') || (role == 'dealer'))
                {
                    ...
                    ({
                        type: "POST",
                        url: "<?php echo e(URL::to('staff/ajax/log/getusers')); ?>",
