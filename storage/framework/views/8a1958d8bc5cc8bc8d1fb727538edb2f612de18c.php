                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="task_add" name="task_add" method="POST" action="<?php echo e(action('employee\EmployeeTaskController@saveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a User..."  class="chosen-select"  style="width: 100%;" tabindex="2" name="task_assign" id="task_assign">
                                            <?php if(!empty($task_assign)): ?>
                                                <?php foreach($task_assign as $key => $value): ?>
