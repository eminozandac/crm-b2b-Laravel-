                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="change_password" name="change_password" method="POST" action="{{ action('admin\ManageEmployeeController@updatePassworddata') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="control-label">{{ $employee->first_name.' '.$employee->last_name }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="control-label">{{ $employee->emailID }}</label>
