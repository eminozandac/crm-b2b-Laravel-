                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td class="content-block" style="padding: 0 0 20px;">
                                         <h4  style="text-align: center; font-size: 24px;color: inherit; font-family: Arial,sans-serif;font-weight: 400; margin-bottom: 10px;word-wrap: normal;margin: 0;"></h4>
                                    </td>
                                </tr>
								<td>
<?php 
									  
										if(isset($orderDetail['companyName']) && !empty($orderDetail['companyName'])){
											?>
										<br/><br/>
<strong>Company  : </strong><label style=""><?php 
												echo $orderDetail['companyName'];
...
<?php 
										...
										if(isset($orderDetail['email']) && !empty($orderDetail['email'])){
											?>
										<br/><br/>
<strong>Email  : </strong><label style=""><?php 
												echo $orderDetail['email'];
...
<?php
												...
												foreach($main_mail as $main_k=>$main_v)
												{
													foreach($main_v as $child_k=>$child_v)
													{
														?>
														<tr>
														 <td><?php echo e($child_v['accessoryName']); ?></td>
														 <td><?php echo e($child_v['order_qty']); ?></td>
														 <td><?php echo e($child_v['discount']); ?></td>
														 <td><?php echo e($child_v['price']); ?></td>
