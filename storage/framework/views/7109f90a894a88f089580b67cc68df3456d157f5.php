    ...
    $(function ()
    {
        ...
        $('#dealer_task_list div.external-event').each(function() {
        ...
        function changeTaskDate()
        {
            ...
            ({
                type: "POST",
                url: "<?php echo e(URL::to('dealer/ajax/log/changetaks')); ?>",
        ...
        $('#dealer_task_calendar').fullCalendar({
            header: {
            ...
            eventClick: function(calEvent, jsEvent, view) {
               ...
               /* $('#info_taks_dealer').text('');
                $('#info_taks_dealer').text(calEvent.task_user);*/
        ...
        function displayAssignTask(value)
        {
            ...
            $('#info_taks_dealer').text('');
            $('#info_taks_dealer').text(task_assignuser);*/
            ...
            ({
                type: "POST",
                url: "<?php echo e(URL::to('dealer/ajax/log/readtaks')); ?>",
