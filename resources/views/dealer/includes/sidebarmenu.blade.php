        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="{{action('dealer\DealerController@profile')}}">Profile</a></li>
                            <li><a href="{{action('dealer\DealerController@logout')}}">Logout</a></li>
                        </ul>
                    </div>
                ...
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\DealerController@dashboard')}}">
                ...
                ?>
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\DealerProductController@index')}}">
				...
				<li class="<?php echo $activeClass; ?>">
                    <a href="{{action('dealer\DealerAccessoryController@accessoryList')}}"> <i class="fa fa-cubes"></i><span class="nav-label">Accessories</span></a>
                </li>
				 <?php
                    $activeClass = '';
				...
				<li class="{{ $activeClass }}">
				  <a href="#"> <i class="fa fa-shopping-cart"></i><span class="nav-label">Orders</span><span class="fa arrow"></span></a>
					...
					<ul class="nav nav-second-level">
						...
						?>
						<li class="{{ $activeClass }}">
							<a href="{{action('dealer\OrderController@index')}}">
							   Product Orders
							</a>
						</li>
						<?php
						...
						?>
						<li class="{{ $activeClass }}">
							<a href="{{action('dealer\OrderController@delaerFinanceOrders')}}">
								Finance Orders
							</a>
						</li>
						<?php
						...
						?>
						<li class="{{ $activeClass }}">
							<a href="{{action('dealer\SpecialOrderController@index')}}">
								Special Orders
							</a>
						</li>
						<?php
						...
						?>
						<li class="{{ $activeClass }}">
							<a href="{{action('dealer\DealerAccessoryController@dealerAccessoryOrder')}}">
								Accessory Orders
							</a>
						</li>
					</ul>
                ...
                ?>
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\OrderController@dealerOrdersInvoiceList')}}">
                ...
                ?>
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\DealerTaskController@index')}}">
                ...
                ?>
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\DealerCalenderController@index')}}">
                ...
                ?>
                <li class="{{ $activeClass }}">
                    <a href="{{action('dealer\DealerLeadsController@index')}}">
                ...
                ?>
                <li class="<?php echo $activeClass; ?>">
                    <a href="{{  URL('/dealer/mediacategoryfile' ) }}"><i class="fa fa-medium"></i> <span class="nav-label">Media File</span></a>
                </li>
                ...
                ?>
                <li class="<?php echo $activeClass; ?>">
                    <a href="{{  URL('/dealer/newslatter' ) }}"><i class="fa fa-envelope-o"></i> <span class="nav-label">Newsletter</span></a>
                </li>
