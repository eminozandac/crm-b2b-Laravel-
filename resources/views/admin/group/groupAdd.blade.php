                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="group_add" name="group_add" method="POST" action="{{ action('admin\GroupController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount" value="{{ $discount }}">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
