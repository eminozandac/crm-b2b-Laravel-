                ...
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div id='dealer_task_list_assign'>
                                <p>All Today Task</p>
                                    <?php
                                    ...
                                    ?>
                                    @if(!empty($task_data))
                                        @foreach($task_data as $task => $value)
									<?php $url = URL::to('dealer/edit-task', $value->task_id); ?>
                                           <a href="{{$url}}"/> 
												<div class='external-event navy-bg'>
													<p style="float: right">{{ date('d-m-Y',strtotime($value->assign_date)) }}</p>
                                                {{ \Illuminate\Support\Str::limit($value->title, $limit = 25, $end = '...')  }}
												</div>
											</a>
                                        @endforeach
                                    @endif
                ...
                <div class="col-lg-9">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Task Calender</h5>
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/dealer/taskadd')}}"  style="background-color: #18A689;padding: 2px 12px;">
                        ...
                        <div class="ibox-content">
                            <div id="dealer_task_calendar"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="task_events" style="display: none;visibility: hidden">{{ $event }}</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required id="assign_date"  class="form-control datetd date" placeholder="mm/dd/yyyy" name="assign_date" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required id="completion_date"  class="form-control datetd date" placeholder="mm/dd/yyyy" name="completion_date" value="">
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="text-left">
                            <h4>
                                <span style="float:left; width: 23%;">Start Date</span> : <strong><span id="info_taks_start"></span></strong>
                            </h4>
                        </div>
                        <br/>
