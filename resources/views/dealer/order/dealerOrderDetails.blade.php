								...
								<input type="hidden" name="orderToken"  id="orderToken" value="<?php echo base64_encode($getOrderTran->order_transactionID); ?>" />
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											if($getOrderTran->finance > 0){
											?>
											<a href="{{URL::to('/dealer/delaerfinanceorders')}}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back </a>
											<?php
											}else{
											?>
													...
													<tr>
														...
														<td>
															<div class="form-group" style="max-width:150px;margin-bottom:0px;">
																...
																<input class="touchspin" style="max-width:150px;" name="qtyedit[]" type="text" value="{{$v}}">
