                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
							...
							<form action="<?php echo e(action('admin\NewStockController@updateInProductionStock')); ?>" method="POST" enctype="multipart/form-data" class="productss" id="stockmaintain">
								<input type="hidden" name="_token"  id="token" value="<?php echo csrf_token(); ?>"/>
								<input type="hidden" name="page"  id="token" value="inproduction"/>
									<div class="col-sm-2">
									...
									<div class="col-sm-2">
										<div class="form-group">
										 <label class="control-label">&nbsp;</label>
										 <br/>
										     <div class="i-checks"><label> <input type="radio"  value="factorystock" id="factorystock" name="qtytype"> <i></i> Factory Stock </label></div>
									...
									<div class="col-sm-2">
										<div class="form-group">
										 <label class="control-label">&nbsp;</label>
										 <br/>
										     <div class="i-checks"><label> <input type="radio" checked  value="inproductiondate" id="inproductiondate" name="qtytype"> <i></i> In Production Date </label></div>
								...
								<table class="table table-striped table-bordered table-hover dataTables-examples" id="stock_table" style="width:100%;" >
									...
									->where('product_status','=','inproduction')
									->where('productStock','>','0')
									->where('deleted_at','=',NULL)
									->orderBy('variationID','asc')->get();
									//print_r($datastoks); exit;
									foreach($datastoks as $stok){
										if($stok->product_status == 'instock' && $stok->productStock != 0 || $stok->product_status == 'inproduction' ){
				...
				$('.changeDate').click(function(){
					...
					if(stockdate != ''){
						...
						if(orderNoteTokenString != ''){
							...
							({
								type: "POST",
								url: "<?php echo e(URL::to('admin/updateproductiondate/')); ?>",
