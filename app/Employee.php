...
class Employee extends Model {
    ...
    protected $fillable = ['employee_id', 'first_name', 'last_name', 'emailID', 'password', 'phone', 'address', 'country', 'role', 'status', 'employeeAvatar', 'created_at', 'updated_at', 'deleted_at'];
