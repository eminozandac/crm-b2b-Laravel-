...
<div class="sidebar-collapse">
    <ul class="nav metismenu" id="side-menu">
        <li class="nav-header">
            <div class="dropdown profile-element">
                ...
                <ul class="dropdown-menu animated fadeInRight m-t-xs">
                    <li><a href="{{action('customer\CustomerController@profile')}}">Profile</a></li>
                    <li><a href="{{action('customer\CustomerController@logout')}}">Logout</a></li>
                </ul>
            </div>
        ...
        ?>
        <li class="{{ $activeClass }}">
            <a href="{{ URL::to('customer/warranty') }}">
