                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="employee_add" name="employee_add" method="POST" action="{{ action('admin\ManageEmployeeController@saveData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
