...
<?php $__env->startSection('contentPages'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="<?php echo e(URL::to('/dealer/dashboard')); ?>">Home</a>
                </li>
                <li class="active">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="warranty_form" name="warranty_form" method="POST" action="<?php echo e(action('dealer\WarrantyDealerController@warrantySaveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control" id="name" name="name" placeholder="john">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" required class="form-control" id="emailID" name="emailID" placeholder="john@mail.com">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
...
<?php $__env->startSection('pagescript'); ?>
    ...
    <script>
        $(function()
        {
            ...
            {
                url: "<?php echo e(URL::to('/dealer/warrantyfile/')); ?>",
                method : "post",
                paramName: "note_file",
                ...
                init: function()
                {
                    ...
                    this.on("success", function (file, serverFileName)
                    {
                        ...
                        var total = json_obj_file.length;
                        for (var i in json_obj_file)
                        {
                            hidden_file_note.push(json_obj_file[i].newname);
                            file_note_names[n] = {"serverFileName": json_obj_file[i].newname, "fileName": json_obj_file[i].oldname, "fileId": n, "downloadUrl":json_obj_file[i].downloadurl};
                            n++;
                    ...
                    this.on("removedfile", function(file,inputEl)
                    {
                        var rmvFile = "";
                        ...
                        if (rmvFile)
                        {
                            ...
                            var file_name_string = hidden_file_note.join(",");
                            $('#hidden_file_images').val(file_name_string);
                            $.post("<?php echo e(URL::to('/dealer/warrantyremove/')); ?>", {
