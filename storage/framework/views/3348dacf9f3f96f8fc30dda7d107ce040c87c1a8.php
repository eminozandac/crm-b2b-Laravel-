        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/dealer/warranty')); ?>">All Warranty Report</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/dealer/warrantyadd')); ?>"  style="background-color: #18A689;">
                                                ...
                                                <table class="table table-striped table-bordered table-hover dataTables-example" id="warranty_table" >
                                                    ...
                                                    <?php if(!empty($warrantyList_pending)): ?>
                                                        <?php foreach($warrantyList_pending as $key => $value): ?>
                                                            ...
                                                            $url_edit = "";
                                                            $url_edit = "/dealer/warrantyedit/".$value->warranty_uniqueID;
            ...
            <script type="text/javascript">
                ...
                $(function (){
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "<?php echo e(URL::to('dealer/ajax/log/warrantydelete')); ?>",
                    ...
                    function datanote_Warranty(uniqueID)
                    {
                        ...
                        ({
                            type: "POST",
                            url: "<?php echo e(URL::to('dealer/ajax/log/warrantynote')); ?>",
