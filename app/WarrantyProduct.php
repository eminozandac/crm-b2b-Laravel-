...
class WarrantyProduct extends Model {
    ...
    protected $table = 'warrantyproduct';

    protected $hidden = array('password', 'remember_token');

    protected $primaryKey = ['warranty_uniqueID','role']; // or null

    public $incrementing = false;

    protected $fillable = ['warranty_uniqueID', 'assign_role', 'warranty_assign', 'role', 'claimNumber', 'user_id', 'name', 'address', 'postcode','emailID', 'phone',
        'product_name', 'product_model', 'purchase_date', 'product_serial_number', 'product_fault', 'part_require', 'product_images',
        'note', 'file_images', 'warranty_status', 'created_at', 'updated_at', 'deleted_at'];

    protected $rules=[
        'warranty_uniqueID'=>'required'
    ];
