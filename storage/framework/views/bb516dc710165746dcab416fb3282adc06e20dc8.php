                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="change_password" name="change_password" method="POST" action="<?php echo e(action('admin\ManageStaffController@updatePassworddata')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 text-left">
                                        <label class="control-label"><?php echo e($staff->first_name.' '.$staff->last_name); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <label class="control-label"><?php echo e($staff->emailID); ?></label>
                                        <input type="hidden" name="emailID" value="<?php echo e($staff->emailID); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
