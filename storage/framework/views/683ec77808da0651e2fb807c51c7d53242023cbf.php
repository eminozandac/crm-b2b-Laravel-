...
<?php $__env->startSection('contentPages'); ?>
		...
		<!--------------------------------invoiced--------------------------------------->
										...
										<div id="tab-3" class="tab-pane">
											...
											<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('admin\OrderController@generateServiceInvoiceData')); ?>" id="order_edit" enctype="multipart/form-data">
