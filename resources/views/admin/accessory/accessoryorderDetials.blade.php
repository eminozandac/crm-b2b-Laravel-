                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content" >
                            <div class="table-responsive">
								...
								<div class="col-md-12">
									<hr/>
									<form action="{{action('admin\AccessoryOrderController@adminUpdateAccesoryOrder')}}" method="POST" enctype="multipart/form-data" class="productss" id="order_edit">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<a href="{{URL::to('/admin/accessoryorderslist')}}" class="btn btn-default pull-right"><i class="fa fa-arrow-left"></i> Back </a>
											</div>
										</div>
									</form>
								</div>
