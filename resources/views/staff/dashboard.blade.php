				...
				<div class="row">
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <h5><a href="{{ URL::to('staff/leadsreport') }}">Today Leads Report</a></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins">{{ $todayLeads }}</h1>
                                <div class="stat-percent font-bold text-info"> </div>
                                <small>Total Leads : {{ $totalLeads }}</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right"></span>
                                <h5><a href="{{ URL::to('staff/task') }}">Today Task</a></h5>
                            </div>
                            <div class="ibox-content">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right"></span>
                                <h5><a href="{{ URL::to('admin/orderList') }}">New Orders</a></h5>
                            </div>
                            <div class="ibox-content">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right"></span>
                                <h5><a href="{{ URL::to('admin/specialorderslist') }}">Special Order</a></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins">{{ $todaySpecialOrder }}</h1>
                                <div class="stat-percent font-bold text-info"> </div>
                                <small>All Special Order : {{ $totalSpecialOrder }}</small>
                            </div>
                        </div>
					</div>
					<div class="col-lg-3">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<span class="label label-info pull-right"></span>
								<h5><a href="{{ URL::to('/admin/orderList') }}">Accessory Orders</a></h5>
							</div>
							<div class="ibox-content">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <h5><a href="{{ URL::to('/staff/warranty') }}">Warranty</a></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins">
                                    <?php
                            ...
                            <div class="ibox-content" id="oder_message">
                                <div class="feed-activity-list">
                                    ...
                                    @if(isset($note) && (!empty($note)))
                                        ...
                                        @foreach($note as $key_note => $value_note)
                                            ...
                                            <div class="feed-element">
                                                <div>
                                                    <small class="pull-right text-navy">{{ $time_text }}</small>
                                                    <strong class="label label-primary"  style="margin-bottom: 10px;">{{ $dealerCompany->company_name }} (<?php echo $dealerCompany->role; ?>) </strong><br/>
                                                    Product : <strong style="margin-bottom: 10px;">{{ $result_product->productName }}</strong><br/>
                                                    <div style="margin-bottom: 10px;"> Description : {{ \Illuminate\Support\Str::limit($value_note->description, $limit = 100, $end = '...')  }}</div>
                                                    <small class="text-muted">
                                                        Time : {{ date('H:i A',strtotime($value_note->created_at)) }} - {{ date('d-m-Y',strtotime($value_note->created_at)) }}
                                                    </small>
                                            ...
                                            <div class="feed-element">
                                                <div>
                                                    ...
                                                    <strong class="pull-right" style="margin-right: 15px;">
                                                        <a href="{{ URL::to('staff/warranty') }}">{{ $model_name }}</a>
                                                    </strong>
                                                    <div>{{ $value->note }}</div>
