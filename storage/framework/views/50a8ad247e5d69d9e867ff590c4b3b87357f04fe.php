...
<html>
	...
	<body class="gray-bg">
		<div class="middle-box text-center loginscreen animated fadeInDown">
			<div class="col-md-12">
				<div>
					<img src="<?php echo e(asset('assets/img/superiorspas.png')); ?>" class="img-responsive"/><br/>
				</div>
				<h3>Welcome to Inventory</h3>
				<?php echo  Session::get('login'); ?>
				<form class="m-t form-horizontal" role="form" method="post" action="<?php echo e(action('admin\LoginController@loginform')); ?>" id="formLogin" >
				...
				<form class="m-t form-horizontal" role="form" method="post" action="<?php echo e(action('admin\LoginController@forgotPasswordAdmin')); ?>" id="formForgot" style="display:none;">
					<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
					<div class="form-group">
						<input type="email" class="form-control" name="email" id="email" placeholder="Email" required="">
					</div>
		...
		<script src="<?php echo e(asset('assets/js/jquery-form-validation.js')); ?>"></script>
