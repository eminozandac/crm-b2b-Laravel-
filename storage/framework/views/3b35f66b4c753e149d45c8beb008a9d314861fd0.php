                    ...
                    <div class="ibox">
                        <div class="ibox-content">
							...
							<form action="<?php echo e(action('admin\NewStockController@updateInProductionStock')); ?>" method="POST" enctype="multipart/form-data" class="productss" id="stockmaintain">
								...
								<input type="hidden" name="page"  id="page" value="arrival"/>
									...
									<div class="col-sm-3">
										 ...
										 <br/>
											<input type="hidden" name="qtytype" id="qtytype" value="instock"/>
											 
											<input type="submit" class="btn btn-w-m btn-primary" id="stockupdate" value="In stock" />
								...
								<table class="table table-striped table-bordered table-hover dataTables-examples" id="stock_table" style="width:100%;" >
									...
									->where('product_status','=','onseaukarrival')
									->where('deleted_at','=',NULL)
									->orderBy('variationID','asc')->get();
									//print_r($datastoks); exit;
									foreach($datastoks as $stok){
										if($stok->productStock != 0 || $stok->product_status == 'onseaukarrival' ){
										  
									if($stok->product_status == 'onseaukarrival' ){
									...
									?>
										<tr>
											...
											<td>
												...
												->where('qtystatus','=','onseaukarrival')
												->where('deleted_at','=',NULL)
												->where('mailstatus','=',0)
												->get();
