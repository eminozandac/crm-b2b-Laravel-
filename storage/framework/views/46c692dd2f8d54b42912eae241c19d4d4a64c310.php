...
<table class="body-wrap" style="    background-color: #f6f6f6;
    ...
    text-align: center;
    border-radius: 3px 3px 0 0;">
                          Hello,<?php echo e($invoice_ar['dealername']); ?>
...
<?php
												...
												foreach($main_mail as $main_k=>$main_v)
												{
													foreach($main_v as $child_k=>$child_v)
													{
														?>
														<tr>
														 <td><?php echo e($child_v['productName']); ?></td>
														 <td><?php echo e($child_v['product_color']); ?></td>
														 <td><?php echo e($child_v['batch']); ?></td>
														 <td><?php echo e($child_v['orderDate']); ?></td>
														 <td><?php echo e($child_v['delivery_date']); ?></td>
														</tr> 
														<?php
													}
													$num++;
