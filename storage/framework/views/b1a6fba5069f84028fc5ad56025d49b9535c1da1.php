			...
			<div class="col-md-4">
				<div class="ibox float-e-margins">
					...
					<div>
						...
						?>
							<img alt="image" style="margin: 0 auto;" class="img-responsive" src="<?php echo e(asset($cavatar)); ?>">
						</div>
						...
						<div class="row">
							<form action="<?php echo e(action('admin\ProfileController@updateAdminAvatar')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="tabs-container">
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="ibox-content col-md-12">
										<div class="col-md-12">
											<form class="m-t form-horizontal" role="form" method="post" action="<?php echo e(action('admin\ProfileController@profileUpdate')); ?>" id="form-login" >
												<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
												<div class="form-group">
							...
							<div id="tab-2" class="tab-pane">
								<div class="panel-body">
									<div class="col-md-12">
										<form class="m-t form-horizontal" role="form" method="post" action="<?php echo e(action('admin\ProfileController@passwordUpdate')); ?>" id="form-login" >
											<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
											<div class="form-group">
