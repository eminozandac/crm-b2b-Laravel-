        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/dealer/specialorders')); ?>">All Special Order List</a>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/dealer/specialorderadd')); ?>"  style="background-color: #18A689;">
                ...
                $(function (){
                    ...
                    var customer_table = $('#specialorder_table').DataTable({
                      ...
                      /*  "aoColumnDefs": [ { "bSortable": true, "aTargets": [ 1,2 ] } ],
                        ...
                        "serverSide": true,
                         "ajax": {
                            url: "<?php echo e(URL::to('dealer/ajax/log/specialdata')); ?>",
                            data:function(d){  }
                        },
                        "columns": [
                        ...
                        swal({
                            ...
                            function(isConfirm){
                                if (isConfirm)
                                {
                                    ...
                                    ({
                                        type: "POST",
                                        url: "<?php echo e(URL::to('dealer/ajax/log/specialorderdelete')); ?>",
