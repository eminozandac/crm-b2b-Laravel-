...
<?php $__env->startSection('contentPages'); ?>
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/dealer/product')); ?>">Product</a>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="special_order" name="special_order" method="POST" action="<?php echo e(action('dealer\SpecialOrderController@saveData')); ?>" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">

                                <input name="_token" type="hidden" id="hidden_token" value="<?php echo e(csrf_token()); ?>"/>
                                <input name="special_orderID" type="hidden" id="special_orderID" value="<?php echo e($specialorderID); ?>"/>
                                <input name="OrderNumber" type="hidden" id="OrderNumber" value="<?php echo e($OrderNumber); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select data-placeholder="Choose a Product..." class="form-control "  style="width: 100%;" tabindex="3" name="product_id" id="product_id">
        ...
        <input name="_token" type="hidden" id="hidden_tokenID" value="<?php echo e(csrf_token()); ?>"/>
		<?php $__env->stopSection(); ?>
                ...
                $(function ()
                {
                   /* $("#product_id").select2({
                    ...
                    function getColor(productID)
                    {
                        ...
                        ({
                            type: "POST",
                            url: "<?php echo e(URL::to('dealer/ajax/log/colordata')); ?>",
					...
					/* function getattribute(productID){
						...
						if(productID !=''){
							...
							({
								type: "POST",
								url: "<?php echo e(URL::to('dealer/ajax/log/attributedata')); ?>",
								data: {data_productID: productID, _token: tokendata},
								cache: false,
								success: function (result) {
