        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="{{URL::to('/admin/warranty')}}">All Warranty Report</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/admin/warrantyadd')}}"  style="background-color: #18A689;">
                                                    ...
                                                    @if(!empty($warrantyList_pending))
                                                        ...
                                                        @foreach($warrantyList_pending as $key => $value)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><span class="badge {{ $role_class }}">{{ $role_a }}</span> {{ $name }}</td>
                                                                <td>{{ $companyName }}</td>
                                                                ...
                                                                <td>
                                                                    <a href="{{ URL::to($url_pdf) }}" class="btn btn-info waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="PDF" style="padding: 0.255rem 0.675rem;">
                                                                        <i class="fa fa-file-pdf-o"></i>
                                                                    </a>

                                                                    <a href="{{ URL::to($url_print) }}" class="btn btn-success waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="PRINT" target="_blank" style="padding: 0.255rem 0.675rem;">
            ...
            <script type="text/javascript">
                ...
                $(function ()
                {
                        ...
                        swal({
                                ...
                                function(isConfirm){
                                    if (isConfirm)
                                    {
                                        ...
                                        ({
                                            type: "POST",
                                            url: "{{ URL::to('admin/ajax/log/warrantydelete') }}",
                    ...
                    function datanote_Warranty(uniqueID)
                    {
                        ...
                        ({
                            type: "POST",
                            url: "{{ URL::to('admin/ajax/log/warrantynote') }}",
