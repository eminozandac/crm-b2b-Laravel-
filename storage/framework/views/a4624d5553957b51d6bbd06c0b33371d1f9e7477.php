        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo e(URL::to('/admin/attributeList')); ?>">All Attribute</a>
                    </li>
                    <li class="active">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="<?php echo e(URL::to('/admin/addAttribute')); ?>"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                ...
                $(function (){
                    ...
                    var group_table = $('#group_table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            url: "<?php echo e(URL::to('admin/ajax/log/attributedata')); ?>",
                            data: function (d) {
                            }
                        },
                        "columns": [
                    ...
                    function deleted(id)
                    {
                        ...
                        function(isConfirm){
                            if (isConfirm)
                            {
                                ...
                                ({
                                    type: "POST",
                                    url: "<?php echo e(URL::to('admin/ajax/log/attributedelete')); ?>",
