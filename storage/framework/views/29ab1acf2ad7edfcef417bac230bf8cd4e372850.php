...
<?php $__env->startSection('contentPages'); ?>
		...
		<!--------------------------------invoiced--------------------------------------->
										...
										<div id="tab-3" class="tab-pane">
											...
											<form class="m-t form-horizontal"  role="form" method="post" action="<?php echo e(action('admin\OrderController@generateInvoice')); ?>" id="order_edit" enctype="multipart/form-data">
	...
	$(function() 
	{
		...
		$('#dealerlist').change(function(){
			...
			$.ajax
				({
					type: "POST",
					url: "<?php echo e(URL::to('admin/getallinvoice')); ?>",
