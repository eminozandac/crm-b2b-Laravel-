	...
	<body class="gray-bg">
		<div class="middle-box text-center loginscreen animated fadeInDown">
			<div class="col-md-12">
				...
				<form class="m-t form-horizontal" role="form" method="post" action="{{action('customer\CustomerController@loginform')}}" id="formLogin" >
				...
				<form class="m-t form-horizontal" role="form" method="post" action="{{action('customer\CustomerController@forgotPasswordCustomer')}}" id="formForgot" style="display:none;">
					<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
					<div class="form-group">
                ...
                <a class="btn btn-sm btn-white btn-block" href="{{ URL::to('/customer/register') }}">Create an account</a>
