                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-w-m btn-primary" href="{{URL::to('/admin/staffadd')}}"  style="background-color: #18A689;">
            ...
            <script type="text/javascript">
                ...
                $(function (){
                    ...
                    var staff_table = $('#staff_table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": {
                            url: "{{ URL::to('admin/ajax/log/staffdata') }}",
                            data:function(d){  }
                        },
                        "columns": [
                    ...
                    function staffdatadelete(val)
                    {
                        ...
                        function(isConfirm){
                            if (isConfirm)
                            {
                                ...
                                ({
                                    type: "POST",
                                    url: "{{ URL::to('admin/ajax/log/staffdelete') }}",
