                ...
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="<?php echo e(action('admin\ProfileController@profile')); ?>">Profile</a></li>
                            <li><a href="<?php echo e(action('admin\LoginController@logout')); ?>">Logout</a></li>
                        </ul>
                    </div>
                ...
                <li class="<?php if (Request::is('admin/dashboard')){echo 'active';} ?>">
                    <a href="<?php echo e(action('admin\LoginController@dashboard')); ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span>
                    </a>
                </li>
