            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
						...
						?>
                         <a href="<?php echo e(URL::to($link)); ?>">Variations</a>
                    </li>
                    <li class="active">
						...
						<div class="tab-content">
							<div id="tab-2" lass="tab-pane active">
								...
								<?php // print_r($variationData); ?>
									<form action="<?php echo e(action('admin\ProductController@updateVariation')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontalssffg" id="variationEdit">
										...
										<fieldset class="form-horizontal">
											...
											<div class="col-sm-3">
												...
												<option <?php if($variationData->product_color =="Tuscan Sun") {echo "selected=selected";}?>  value="Tuscan Sun" data-thumbnail="<?php echo e(asset('assets/img/tuscan.jpg')); ?>">Tuscan Sun</option>
										 
												<option <?php if($variationData->product_color =="Pearl White") {echo "selected=selected";}?>  value="Pearl White" data-thumbnail="<?php echo e(asset('assets/img/pearl.jpg')); ?>">Pearl White</option>
												
												<option <?php if($variationData->product_color =="Sterling Silver") {echo "selected=selected";}?>  value="Sterling Silver" data-thumbnail="<?php echo e(asset('assets/img/sterling.jpg')); ?>">Sterling Silver</option>
												
												<option <?php if($variationData->product_color =="Cameo") {echo "selected=selected";}?>  value="Cameo" data-thumbnail="<?php echo e(asset('assets/img/cameo.jpg')); ?>">Cameo</option>
												
												<option <?php if($variationData->product_color =="Tranquility") {echo "selected=selected";}?>  value="Tranquility" data-thumbnail="<?php echo e(asset('assets/img/tranq.jpg')); ?>">Tranquility</option>
												
												<option <?php if($variationData->product_color =="Storm Clouds") {echo "selected=selected";}?>  value="Storm Clouds" data-thumbnail="<?php echo e(asset('assets/img/strom.jpg')); ?>">Storm Clouds</option>
												
												<option <?php if($variationData->product_color =="Cinnabar") {echo "selected=selected";}?>  value="Cinnabar" data-thumbnail="<?php echo e(asset('assets/img/cinnabar.jpg')); ?>">Cinnabar</option>
												
												<option <?php if($variationData->product_color =="Midnight Canyon") {echo "selected=selected";}?>  value="Midnight Canyon" data-thumbnail="<?php echo e(asset('assets/img/midnight.jpg')); ?>">Midnight Canyon</option>
												
												<option <?php if($variationData->product_color =="Winter Solstice") {echo "selected=selected";}?>  value="Winter Solstice" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">Winter Solstice</option>
												
												<option <?php if($variationData->product_color =="Blue") {echo "selected=selected";}?>  value="Blue" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">Blue</option>
												
												<option <?php if($variationData->product_color =="White with Grey Sides") {echo "selected=selected";}?>  value="White with Grey Sides" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">White with Grey Sides</option>
												
												<option <?php if($variationData->product_color =="White with Brown Sides") {echo "selected=selected";}?>  value="White with Brown Sides" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">White with Brown Sides</option>
												
												<option <?php if($variationData->product_color =="Black with Black Sides") {echo "selected=selected";}?>  value="Black with Black Sides" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">Black with Black Sides</option>
												<option <?php if($variationData->product_color =="Black with Grey Sides") {echo "selected=selected";}?>  value="Black with Grey Sides" data-thumbnail="<?php echo e(asset('assets/img/winter.jpg')); ?>">Black with Grey Sides</option>
