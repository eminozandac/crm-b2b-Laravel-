                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="mediacategory_edit" name="mediacategory_edit" method="POST" action="{{ action('admin\MediaSubCategoryController@editData') }}" class="form-horizontal" enctype="multipart/form-data" style="min-height: 100vh;">
