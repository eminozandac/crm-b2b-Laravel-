...
@section('contentPages')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox-content m-b-sm border-bottom">
            <div class="row">
				<form class="m-t form-horizontal"  role="form" method="post" action="{{action('dealer\DealerProductController@productByCategory')}}" id="form_customer_profile" >
					<div class="col-sm-4">
...
@section('pagescript')
	...
	$(function() {
		...
		function getProductData(){
			...
			({
				type: "POST",
				url: "{{URL::to('dealer/ajax/log/getdelaerproducs')}}",
