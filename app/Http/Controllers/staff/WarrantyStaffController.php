...
class WarrantyStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            return View::make('warranty/staff/staffWarrantyList',$data);
        }else{
    ...
    public function warrantyAdd()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            return View::make('warranty/staff/staffWarrantyAdd',$data);
        }else{
        ...
        if(isset($id) && ($id != 0))
        {
                ...
                && (($data_post['method_process'] == 'add') || ($data_post['method_process'] == 'edit')) )
            {
                ...
                if ($validator->fails())
                {
                    ...
                    return Redirect::to('/staff/warrantyadd');
                }else
                {
                    $update_post = array();
                    ...
                    if(!empty($primary_key)) {
                        ...
                        if(!empty($result_warranty_product))
                        {
                            ...
                            if(!empty($staff_emailID_result))
                            {
                                ...
                                $warranty_info = array(
                                    'title_message' => 'Staff Change Warranty Product Details',
                                    'to_name' => $assign_name,
                                    'name' => $update_post['name'],
                                    'emailID' => $update_post['emailID'],
                                    'product_model' => $update_post['product_model'],
                        ...
                        return Redirect::to('/staff/warranty');
                    }else{
                        Session::flash('operationFaild','Some thing went wrong!');
                        if($data_post['method_process'] == 'add')
                        {
                        ...
                        {
                            return Redirect::to('/staff/warrantyedit/'.$data_post['warranty_uniqueID']);
                        }else{
                            return Redirect::to('/staff/warranty');
                        }
                    }
    ...
    public function warrantyEdit($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result)){
                ...
                return View::make('warranty/staff/staffWarrantyEdit',$data);
            }else{
                return Redirect::to('staff/warranty');
            }
        }else{
    ...
    public function warrantyPDF($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            {
                $data['warrantyData'] = $result;
                $data['return_url'] = URL::to('staff/warranty');
                ...
                $pdf = PDF::loadView('warranty/staff/pdfFormate', $data);
    ...
    public function warrantyPrint($editid)
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result))
            {
                ...
                return View::make('warranty/staff/pdfFormate',$data);
    ...
    public function noteDataForm()
    {
        ...
        if(isset($id) && ($id != 0))
        {
            ...
            if(!empty($result))
            {
                ...
                return View::make('warranty/staff/noteWarranty',$data);
            }else{
                echo '444';
                exit;
            }
