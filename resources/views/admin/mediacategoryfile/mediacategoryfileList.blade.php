            ...
            <div class="col-lg-10">
                <h2>
                    ...
                    <div class="col-md-2 pull-right">
                        <a href="{{ URL::to('admin/mediacategoryfileadd') }}" class="btn btn-primary btn-block">Upload Files</a>
                    </div>
                </h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>
                        <a href="{{URL::to('/admin/mediacategoryfile')}}">All Media Category</a>
                    </li>
                    <?php
                                        ...
                                        <div class="file" >
                                            <a href="{{ URL::to($action_url) }}">
                                                ...
                                                <div class="file-name" style="padding: 5px;">
                                                    <span style="text-align: left;">{{ $value->name }}</span>
                                                    <br/>
                                    ...
                                    <div class="file-box">
                                        <div class="file">
                                            ...
                                            <div class="file-name text-center">
                                                ...
                                                @if(in_array($value->file_type,$image_file_type_ar))
                                                    <a href="{{ URL::to($download_url) }}" class="btn btn-info waves-effect waves-light"  style="padding: 0.255rem 0.675rem;" title="{{ $original_filename }}" data-gallery="">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                  @else
                                                ...
                                                <a class="btn btn-danger waves-effect waves-light" style="padding: 0.255rem 0.675rem;" data-toggle="tooltip" data-placement="top" title="DELETE" onclick="deleted('{{ $value->media_file_uniqueID }}')">
                    ...
                    function deleted(id)
                    {
                        ...
                        function(isConfirm){
                            if (isConfirm)
                            {
                                ...
                                ({
                                    type: "POST",
                                    url: "{{ URL::to('admin/ajax/log/mediafiledelete') }}",
