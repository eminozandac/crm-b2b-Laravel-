        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                         <a href="<?php echo e(URL::to('/admin/productList')); ?>">Products</a>
                    </li>
                    <li class="active">
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane <?php if(Session::get('variation') || Session::get('attribute')){}else{echo 'active';} ?>">
								...
								<div class="panel-body">
                                    <form action="<?php echo e(action('admin\ProductController@updateProductsinfo')); ?>" method="POST" enctype="multipart/form-data" class="products" id="">
							...
							<div id="tab-2" class="tab-pane <?php if(Session::get('variation')){echo 'active';} ?>">
								<div class="panel-body">
									...
									<form action="<?php echo e(action('admin\ProductController@addProductsVariation')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontalssffg" id="attributes">
										<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
										<input type="hidden" name="productToken" value="<?php echo base64_encode($productData->product_id); ?>"/>
										<fieldset class="form-horizontal">
											<div class="col-sm-3">
							...
							<div id="tab-4" class="tab-pane">
								<div class="panel-body">
                                    <form action="<?php echo e(action('admin\ProductController@updateProductimage')); ?>" method="POST" enctype="multipart/form-data" class="products" id="">
                                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"/>
                                        <input type="hidden" name="productToken" value="<?php echo base64_encode($productData->product_id); ?>"/>
                                        <fieldset class="form-horizontal">
										<?php 
							...
							<div id="tab-5" class="tab-pane <?php if(Session::get('attribute')){echo 'active';} ?>">
								<div class="panel-body">
									<form action="<?php echo e(action('admin\ProductController@addproductsattributes')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontalssffg" id="attributes">
										<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>" />
										 <input type="hidden" name="productToken" value="<?php echo base64_encode($productData->product_id); ?>"/>
										<fieldset class="form-horizontal">
											<div class="col-sm-3">
										...
										<table class="table table-striped table-bordered table-hover dataTables-example" id="" style="width:100%;" >
											...
											<tbody>
												<?php 
													...
													?>	
												<tr>
													<td><?php echo e($attrsName->attributeName); ?></td>
				...
				//console.log(accssory);
					...
					function(isConfirm){
						if (isConfirm) {
							 ...
							 window.location.replace("<?php echo e(URL::to('admin/deletevariation')); ?>/"+product);
				...
				//console.log(accssory);
					...
					function(isConfirm){
						if (isConfirm) {
							 ...
							 window.location.replace("<?php echo e(URL::to('admin/deleteatributes')); ?>/"+productattr);
